---
name: impeccable
description: Internal Impeccable design reference and scripts. Load when explicitly using Impeccable commands, references, live tooling, or the ui-ux-improvement skill asks for it.
version: 3.1.1
...
```bash
node ~/.pi/agent/skills/impeccable/scripts/pin.mjs <pin|unpin> <command>
```
