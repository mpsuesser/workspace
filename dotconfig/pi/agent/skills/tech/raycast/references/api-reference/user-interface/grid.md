...
#### GridWithUsePromisePagination.tsx
...
| searchBarAccessory   | Grid.Dropdown that will be shown in the right-hand-side of the search bar.                                                                                                                                                                                                                                                                                                                                                                                                                          | `ReactElement<`[`List.Dropdown.Props`](list.md#props)`, string>` | -       |
...
![Grid EmptyView illustration](https://developers.raycast.com/files/s6aDd2fApHeaFIDeNSfs)
...
| Prop                                      | Description                                                                                                                                                                                         | Type                                                                                                                                                                                                                                                                                                                                                        | Default |
| ----------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| content\* | An image or color, optionally with a tooltip, representing the content of the grid item.                                                                                                            | [`Image.ImageLike`](https://developers.raycast.com/api-reference/user-interface/pages/-MiwANRdFuMoKkR6at_E#image.imagelike) or `{ color:` [`Color.ColorLike`](https://developers.raycast.com/api-reference/user-interface/pages/-MiwANRbUk391XIQ6FMp#color.colorlike) `}` or `{ tooltip: string; value: Image.ImageLike` or `{ color: Color.ColorLike; } }` | -       |
...
![Grid.Item accessories illustration](https://developers.raycast.com/files/GQZ4qeKv0KK4Bc3ZkCw8)
