...
![](https://developers.raycast.com/files/41OfRpa5JkNXR8pAsfam)
...
For convenience, most of the [hooks](../../utilities/getting-started.md) that we provide have built-in pagination support. Here's an example of how to add pagination support to a simple command using [usePromise](../../utilities/react-hooks/usepromise.md), and one "from scratch".

#### ListWithUsePromisePagination.tsx
...
| icon                                    | An optional icon displayed for the item.                                                                                                                                      | [`Image.ImageLike`](https://developers.raycast.com/api-reference/user-interface/pages/-MiwANRdFuMoKkR6at_E#image.imagelike) | -       |
...
![List EmptyView illustration](https://developers.raycast.com/files/mdXUYcNAfddmYJFvUIwb)
...
| icon        | An icon displayed in the center of the EmptyView.        | [`Image.ImageLike`](https://developers.raycast.com/api-reference/user-interface/pages/-MiwANRdFuMoKkR6at_E#image.imagelike) | -       |
...
| icon                                    | An optional icon displayed for the list item.                                                                                                                                                       | [`Image.ImageLike`](https://developers.raycast.com/api-reference/user-interface/pages/-MiwANRdFuMoKkR6at_E#image.imagelike) or `{ tooltip: string; value:` [`Image.ImageLike`](https://developers.raycast.com/api-reference/user-interface/pages/-MiwANRdFuMoKkR6at_E#image.imagelike) `}` | -       |
...
![List-detail illustration](https://developers.raycast.com/files/7MguwNP1jC9ukMUfAvWS)
...
![List Detail-metadata illustration](https://developers.raycast.com/files/FcKO8zbXD4sW4MYKUTPi)
...
![List Detail-metadata illustration](https://developers.raycast.com/files/X4WxIOwT1I8sRWSIGD6t)
...
![List Detail-metadata-label illustration](https://developers.raycast.com/files/ZP44rqZBvwN0hxLymJNj)
...
![List Detail-metadata-link illustration](https://developers.raycast.com/files/STwSICqFjBbJmQeWKHRf)
...
![List Detail-metadata-tag-list illustration](https://developers.raycast.com/files/bb9ZVg8jl2HYlqKRPzlq)
...
![List Detail-metadata-separator illustration](https://developers.raycast.com/files/kv6fZqxMSuHkvZ0ukvmb)
...
![List.Item accessories illustration](https://developers.raycast.com/files/ZtIFUjcD0aw4Ahlo0ERB)

#### Properties

| Property                              | Description                                                                                                                                                                                                                                                                                                                                                                     | Type                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| tag\* | A string or Date that will be used as the label, optionally colored. The date is formatted relatively to the current time (for example `new Date()` will be displayed as `"now"`, yesterday's Date will be displayed as "1d", etc.). Color changes the text color to the provided color and sets a transparent background with the same color. Defaults to Color.SecondaryText. | `string` or [`Date`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date) or `undefined` or `null` or `{ color?:` [`Color.ColorLike`](https://developers.raycast.com/api-reference/user-interface/pages/-MiwANRbUk391XIQ6FMp#color.colorlike)`; value: string` or [`Date`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date) or `undefined` or `null }` |
| text                                  | An optional text that will be used as the label, optionally colored. Color changes the text color to the provided color. Defaults to Color.SecondaryText.                                                                                                                                                                                                                       | `string` or `null` or `{ color?:` [`Color`](colors.md#color)`; value: string` or `undefined` or `null }`                                                                                                                                                                                                                                                                                         |
| date                                  | An optional Date that will be used as the label, optionally colored. The date is formatted relatively to the current time (for example `new Date()` will be displayed as `"now"`, yesterday's Date will be displayed as "1d", etc.). Color changes the text color to the provided color. Defaults to Color.SecondaryText.                                                       | [`Date`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date) or `null` or `{ color?:` [`Color`](colors.md#color)`; value:` [`Date`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date) or `undefined` or `null }`                                                                                                         |
| icon                                  | An optional Image.ImageLike that will be used as the icon.                                                                                                                                                                                                                                                                                                                      | [`Image.ImageLike`](https://developers.raycast.com/api-reference/user-interface/pages/-MiwANRdFuMoKkR6at_E#image.imagelike) or `null`                                                                                                                                                                                                                                                                                          |
