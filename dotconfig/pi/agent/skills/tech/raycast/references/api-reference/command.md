...
| ----------------------------------------- | ------------------------------------------------------------------------------ | --------------------------------- |
| options\* | Options to launch a command within the same extension or in another extension. | [`LaunchOptions`](#launchoptions) |
...
| type\* | LaunchType.UserInitiated or LaunchType.Background                                                                                                                       | [`LaunchType`](environment.md#launchtype)               |
