...
![](https://developers.raycast.com/files/4BR0dw7NodK8i3shfTho)
...
![](https://developers.raycast.com/files/SFTqaYShuPbXpr3QmgIF)
...
| ----------------------------------------- | ------------------------------------------------------------------- | ----------------------------------------------------- |
| options\* | [`AuthorizationRequestOptions`](#oauth.authorizationrequestoptions) | The options used to create the authorization request. |
...
| Name                                      | Type                                                                                                             | Description                    |
| ----------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ------------------------------ |
| options\* | [`AuthorizationRequest`](#oauth.authorizationrequest) `\|` [`AuthorizationOptions`](#oauth.authorizationoptions) | The options used to authorize. |
...
| Name                                      | Type                                                                                     | Description                              |
| ----------------------------------------- | ---------------------------------------------------------------------------------------- | ---------------------------------------- |
| options\* | [`TokenSetOptions`](#oauth.tokensetoptions) `\|` [`TokenResponse`](#oauth.tokenresponse) | The options used to store the token set. |
...
| redirectMethod\* | The redirect method for the OAuth flow. Make sure to set this to the correct method for the provider, see OAuth.RedirectMethod for more information.                                                                                    | [`OAuth.RedirectMethod`](#oauth.redirectmethod)                                                              |
...
| providerIcon                                     | An icon displayed in the OAuth overlay. Make sure to provide at least a size of 64x64 pixels.                                                                                                                                           | [`Image.ImageLike`](https://developers.raycast.com/api-reference/pages/-MiwANRdFuMoKkR6at_E#image.imagelike) |
...
| AppURI | Use this type for a URI-style app scheme that directly opens Raycast. In the OAuth app, configure `com.raycast:/oauth?package\_name=Extension`<br>(Note the single slash – Google, for example, would require this flavor for an OAuth app where the Bundle ID is `com.raycast`)                                                                                                                                                                                                                                                                                                                                                       |
...
| Property                                        | Description                                                                               | Type     |
| ----------------------------------------------- | ----------------------------------------------------------------------------------------- | -------- |
| access\_token\* | The `access_token` value returned by an OAuth token request.                              | `string` |
