...
Ask AI anything you want. Use this in “no-view” Commands, effects, or callbacks. In a React component, you might want to use the [useAI util hook](../utilities/react-hooks/useai.md) instead.
...
| ---------------------------------------- | ------------------------------------------------------------ | --------------------------------- |
| prompt\* | The prompt to ask the AI.                                    | `string`                          |
...
| Anthropic\_Claude\_4.7\_Opus                     | Anthropic's most powerful model with combined reasoning and non-reasoning capabilities.                            |
