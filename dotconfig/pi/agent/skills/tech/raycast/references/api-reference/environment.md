...
| --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------- |
| appearance\*        | The appearance used by the Raycast application.                                                                                   | `"dark"` or `"light"`                   |
| assetsPath\*        | The absolute path to the assets directory of the extension.                                                                       | `string`                                |
| commandMode\*       | The mode of the launched command, as specified in package.json                                                                    | `"view"` or `"no-view"` or `"menu-bar"` |
...
| launchType\*        | The type of launch for the command (user initiated or background).                                                                | [`LaunchType`](#launchtype)             |
