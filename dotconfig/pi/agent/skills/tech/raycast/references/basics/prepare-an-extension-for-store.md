...
![Example of a good subtitle](https://developers.raycast.com/files/AoTJ6VsCvwMflYOf1Lm8)
...
* If you have separate light and dark icons, refer to the `package.json` [manifest](../information/manifest.md#extension-properties) documentation on how to configure them
...
![Onboarding button linking to the README file](https://developers.raycast.com/files/o0U35MGPuq5VRcFszsoH)

## Categories

![Categories shown on an extension details screen](https://developers.raycast.com/files/7RvX7ceuh02P85dHPiDM)
...
* Add categories in the `package.json` [manifest](../information/manifest.md) file or select the categories when you create a new extension using the **Create Extension** command
...
![An example of an extension with screenshot metadata](https://developers.raycast.com/files/ykvwBSPepcNhHEnADbyt)
...
![A CHANGELOG.md file displayed in the app](https://developers.raycast.com/files/M4KNfjU1SVT7IKlTEQoM)
...
![Required preferences will be shown when opening the command](https://developers.raycast.com/files/NiyWDG1UgtLHDdtt8URC)

* Use the [preferences API](../api-reference/preferences.md) to let your users configure your extension or for providing credentials like API tokens
...
![Raycast Action Panel component](https://developers.raycast.com/files/EDh59CKqojRCu2iZn1yA)
...
* Use the [Navigation API](../api-reference/user-interface/navigation.md) for pushing new screens. This will ensure that a user can navigate within your extension the same way as in the rest of the application.
...
* When you update lists with an empty array of elements, the "No results" view will be shown. You can customize this view by using the [List.EmptyView](https://developers.raycast.com/basics/pages/-MeevfnZ89DYcs83emWH#list.emptyview) or [Grid.EmptyView](https://developers.raycast.com/basics/pages/naDQuMmptXPU96Do4Uzd#grid.emptyview) components.
* **Common mistake** - "flickering empty state view" on start
  * If you try rendering an empty list before real data arrives (e.g. from the network or disk), you might see a flickering "No results" view when opening the extension. To prevent this, make sure not to return an empty list of items before you get the data you want to display. In the meantime, you can show the loading indicator. See [this example](../information/best-practices.md#show-loading-indicator).
