...
![Example: Safely share secrets with Doppler](https://developers.raycast.com/files/bqURwpu5VThrgZ2yaTZt)
...
* The `<ShareSecretAction>` returns an [`<Action.SubmitForm>`](https://developers.raycast.com/examples/pages/-MiwANRaRK1jG1WJw3dy#action.submitform).
