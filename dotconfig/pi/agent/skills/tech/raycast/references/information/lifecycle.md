...
* The command was launched in the [background](lifecycle/background-refresh.md).
...
* A user clicks a [Deeplink](lifecycle/deeplinks.md)
...
| -------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| arguments\*  | Use these values to populate the initial state for your command.                                                                                                             | [`Arguments`](lifecycle/arguments.md#arguments)                                       |
| launchType\* | The type of launch for the command (user initiated or background).                                                                                                           | [`LaunchType`](../api-reference/environment.md#launchtype)                                           |
