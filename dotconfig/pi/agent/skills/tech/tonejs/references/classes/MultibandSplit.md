...
#### Hierarchy ([view full](../hierarchy.md#MultibandSplit))

- [ToneAudioNode](ToneAudioNode.md)<MultibandSplitOptions>
  - MultibandSplit

- Defined in [Tone/component/channel/MultibandSplit.ts:36](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/MultibandSplit.ts#L36)

## Constructors

### constructor

- new MultibandSplit(lowFrequency?, highFrequency?): [MultibandSplit](MultibandSplit.md)

- #### Parameters

  - `Optional` lowFrequency: [Unit](../modules/Unit.md).[Frequency](../types/Unit.Frequency.md)
    the low/mid crossover frequency
  - `Optional` highFrequency: [Unit](../modules/Unit.md).[Frequency](../types/Unit.Frequency.md)
    the mid/high crossover frequency

  #### Returns [MultibandSplit](MultibandSplit.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/component/channel/MultibandSplit.ts:106](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/MultibandSplit.ts#L106)

- new MultibandSplit(options?): [MultibandSplit](MultibandSplit.md)

- #### Parameters

  - `Optional` options: Partial<MultibandSplitOptions>

  #### Returns [MultibandSplit](MultibandSplit.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/component/channel/MultibandSplit.ts:107](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/MultibandSplit.ts#L107)
...
- Defined in [Tone/component/channel/MultibandSplit.ts:100](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/MultibandSplit.ts#L100)
...
high: [Filter](Filter.md) = ...

The high band output.

- Defined in [Tone/component/channel/MultibandSplit.ts:79](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/MultibandSplit.ts#L79)

### `Readonly` highFrequency

highFrequency: [Signal](Signal.md)<"frequency">

The mid/high crossover frequency.

- Defined in [Tone/component/channel/MultibandSplit.ts:93](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/MultibandSplit.ts#L93)
...
- Defined in [Tone/component/channel/MultibandSplit.ts:42](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/MultibandSplit.ts#L42)

### `Readonly` low

low: [Filter](Filter.md) = ...

The low band.

- Defined in [Tone/component/channel/MultibandSplit.ts:52](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/MultibandSplit.ts#L52)

### `Readonly` lowFrequency

lowFrequency: [Signal](Signal.md)<"frequency">

The low/mid crossover frequency.

- Defined in [Tone/component/channel/MultibandSplit.ts:88](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/MultibandSplit.ts#L88)

### `Readonly` mid

mid: [Filter](Filter.md) = ...

The mid band output.

- Defined in [Tone/component/channel/MultibandSplit.ts:70](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/MultibandSplit.ts#L70)

### `Readonly` name

name: string = "MultibandSplit"

The name of the class

Overrides [ToneAudioNode](ToneAudioNode.md).[name](ToneAudioNode.md#name)

- Defined in [Tone/component/channel/MultibandSplit.ts:37](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/MultibandSplit.ts#L37)
...
- Defined in [Tone/component/channel/MultibandSplit.ts:47](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/MultibandSplit.ts#L47)
...
- Clean up.
  ...
  - Defined in [Tone/component/channel/MultibandSplit.ts:159](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/MultibandSplit.ts#L159)
...
- get(): MultibandSplitOptions

- Get the object's attributes.

  #### Returns MultibandSplitOptions
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<MultibandSplitOptions>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](MultibandSplit.md#toDestination)
...
- getDefaults(): MultibandSplitOptions

- #### Returns MultibandSplitOptions

  Overrides [ToneAudioNode](ToneAudioNode.md).[getDefaults](ToneAudioNode.md#getDefaults)

  - Defined in [Tone/component/channel/MultibandSplit.ts:148](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/MultibandSplit.ts#L148)
