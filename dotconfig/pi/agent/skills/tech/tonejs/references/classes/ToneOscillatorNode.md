...
Wrapper around the native fire-and-forget OscillatorNode. Adds the ability to reschedule the stop method. ***[Oscillator](Oscillator.md) is better for most use-cases***

#### Hierarchy

- OneShotSource<[ToneOscillatorNodeOptions](../interfaces/ToneOscillatorNodeOptions.md)>
  - ToneOscillatorNode

- Defined in [Tone/source/oscillator/ToneOscillatorNode.ts:20](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/oscillator/ToneOscillatorNode.ts#L20)

## Constructors

### constructor

- new ToneOscillatorNode(frequency, type): [ToneOscillatorNode](ToneOscillatorNode.md)
...
- #### Parameters
  ...
  #### Returns [ToneOscillatorNode](ToneOscillatorNode.md)

  Overrides OneShotSource<ToneOscillatorNodeOptions>.constructor

  - Defined in [Tone/source/oscillator/ToneOscillatorNode.ts:43](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/oscillator/ToneOscillatorNode.ts#L43)

- new ToneOscillatorNode(options?): [ToneOscillatorNode](ToneOscillatorNode.md)

- #### Parameters

  - `Optional` options: Partial<[ToneOscillatorNodeOptions](../interfaces/ToneOscillatorNodeOptions.md)>

  #### Returns [ToneOscillatorNode](ToneOscillatorNode.md)

  Overrides OneShotSource<ToneOscillatorNodeOptions>.constructor

  - Defined in [Tone/source/oscillator/ToneOscillatorNode.ts:44](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/oscillator/ToneOscillatorNode.ts#L44)
...
detune: [Param](Param.md)<"cents">

The detune of the oscillator

- Defined in [Tone/source/oscillator/ToneOscillatorNode.ts:37](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/oscillator/ToneOscillatorNode.ts#L37)

### `Readonly` frequency

frequency: [Param](Param.md)<"frequency">

The frequency of the oscillator

- Defined in [Tone/source/oscillator/ToneOscillatorNode.ts:32](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/oscillator/ToneOscillatorNode.ts#L32)
...
name: string = "ToneOscillatorNode"

Overrides OneShotSource.name

- Defined in [Tone/source/oscillator/ToneOscillatorNode.ts:21](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/oscillator/ToneOscillatorNode.ts#L21)
...
- The oscillator type. Either 'sine', 'sawtooth', 'square', or 'triangle'
  ...
  - Defined in [Tone/source/oscillator/ToneOscillatorNode.ts:110](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/oscillator/ToneOscillatorNode.ts#L110)
...
- #### Parameters
  ...
  - Defined in [Tone/source/oscillator/ToneOscillatorNode.ts:113](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/oscillator/ToneOscillatorNode.ts#L113)
...
- Clean up.
  ...
  - Defined in [Tone/source/oscillator/ToneOscillatorNode.ts:120](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/oscillator/ToneOscillatorNode.ts#L120)
...
- get(): [ToneOscillatorNodeOptions](../interfaces/ToneOscillatorNodeOptions.md)

- Get the object's attributes.

  #### Returns [ToneOscillatorNodeOptions](../interfaces/ToneOscillatorNodeOptions.md)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[ToneOscillatorNodeOptions](../interfaces/ToneOscillatorNodeOptions.md)>
...
- setPeriodicWave(periodicWave): this
...
- Sets an arbitrary custom periodic waveform given a PeriodicWave.
  ...
  - Defined in [Tone/source/oscillator/ToneOscillatorNode.ts:102](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/oscillator/ToneOscillatorNode.ts#L102)
...
- Start the oscillator node at the given time
  ...
  - Defined in [Tone/source/oscillator/ToneOscillatorNode.ts:86](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/oscillator/ToneOscillatorNode.ts#L86)
...
- Connect the output to the context's destination node.
  ...
  [toDestination](ToneOscillatorNode.md#toDestination)
...
- getDefaults(): [ToneOscillatorNodeOptions](../interfaces/ToneOscillatorNodeOptions.md)

- #### Returns [ToneOscillatorNodeOptions](../interfaces/ToneOscillatorNodeOptions.md)

  Overrides OneShotSource.getDefaults

  - Defined in [Tone/source/oscillator/ToneOscillatorNode.ts:74](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/oscillator/ToneOscillatorNode.ts#L74)
