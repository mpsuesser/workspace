...
#### Hierarchy ([view full](../hierarchy.md#Delay))

- [ToneAudioNode](ToneAudioNode.md)<[DelayOptions](../interfaces/DelayOptions.md)>
  - Delay

- Defined in [Tone/core/context/Delay.ts:24](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/core/context/Delay.ts#L24)

## Constructors

### constructor

- new Delay(delayTime?, maxDelay?): [Delay](Delay.md)

- #### Parameters

  - `Optional` delayTime: [Unit](../modules/Unit.md).[Time](../types/Unit.Time.md)
    The delay applied to the incoming signal.
  - `Optional` maxDelay: [Unit](../modules/Unit.md).[Time](../types/Unit.Time.md)
  ...
  - Defined in [Tone/core/context/Delay.ts:54](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/core/context/Delay.ts#L54)

- new Delay(options?): [Delay](Delay.md)

- #### Parameters

  - `Optional` options: Partial<[DelayOptions](../interfaces/DelayOptions.md)>

  #### Returns [Delay](Delay.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/core/context/Delay.ts:55](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/core/context/Delay.ts#L55)
...
- Defined in [Tone/core/context/Delay.ts:41](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/core/context/Delay.ts#L41)
...
- Defined in [Tone/core/context/Delay.ts:47](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/core/context/Delay.ts#L47)
...
- Defined in [Tone/core/context/Delay.ts:25](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/core/context/Delay.ts#L25)
...
- Defined in [Tone/core/context/Delay.ts:48](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/core/context/Delay.ts#L48)
...
- The maximum delay time. This cannot be changed after the value is passed into the constructor.
  ...
  - Defined in [Tone/core/context/Delay.ts:97](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/core/context/Delay.ts#L97)
...
- Clean up.
  ...
  - Defined in [Tone/core/context/Delay.ts:104](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/core/context/Delay.ts#L104)
...
- get(): [DelayOptions](../interfaces/DelayOptions.md)

- Get the object's attributes.

  #### Returns [DelayOptions](../interfaces/DelayOptions.md)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[DelayOptions](../interfaces/DelayOptions.md)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](Delay.md#toDestination)
...
- getDefaults(): [DelayOptions](../interfaces/DelayOptions.md)

- #### Returns [DelayOptions](../interfaces/DelayOptions.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[getDefaults](ToneAudioNode.md#getDefaults)

  - Defined in [Tone/core/context/Delay.ts:86](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/core/context/Delay.ts#L86)
