...
[Compressor](Compressor.md) and [MultibandSplit](MultibandSplit.md)
...
#### Hierarchy ([view full](../hierarchy.md#MultibandCompressor))

- [ToneAudioNode](ToneAudioNode.md)<[MultibandCompressorOptions](../interfaces/MultibandCompressorOptions.md)>
  - MultibandCompressor

- Defined in [Tone/component/dynamics/MultibandCompressor.ts:36](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/MultibandCompressor.ts#L36)

## Constructors

### constructor

- new MultibandCompressor(options?): [MultibandCompressor](MultibandCompressor.md)

- #### Parameters

  - `Optional` options: RecursivePartial<[MultibandCompressorOptions](../interfaces/MultibandCompressorOptions.md)>

  #### Returns [MultibandCompressor](MultibandCompressor.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/component/dynamics/MultibandCompressor.ts:72](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/MultibandCompressor.ts#L72)
...
high: [Compressor](Compressor.md)

The compressor applied to the high frequencies

- Defined in [Tone/component/dynamics/MultibandCompressor.ts:70](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/MultibandCompressor.ts#L70)
...
- Defined in [Tone/component/dynamics/MultibandCompressor.ts:55](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/MultibandCompressor.ts#L55)
...
- Defined in [Tone/component/dynamics/MultibandCompressor.ts:39](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/MultibandCompressor.ts#L39)

### `Readonly` low

low: [Compressor](Compressor.md)

The compressor applied to the low frequencies

- Defined in [Tone/component/dynamics/MultibandCompressor.ts:60](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/MultibandCompressor.ts#L60)
...
- Defined in [Tone/component/dynamics/MultibandCompressor.ts:50](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/MultibandCompressor.ts#L50)

### `Readonly` mid

mid: [Compressor](Compressor.md)

The compressor applied to the mid frequencies

- Defined in [Tone/component/dynamics/MultibandCompressor.ts:65](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/MultibandCompressor.ts#L65)

### `Readonly` name

name: string = "MultibandCompressor"

The name of the class

Overrides [ToneAudioNode](ToneAudioNode.md).[name](ToneAudioNode.md#name)

- Defined in [Tone/component/dynamics/MultibandCompressor.ts:37](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/MultibandCompressor.ts#L37)
...
- Defined in [Tone/component/dynamics/MultibandCompressor.ts:40](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/MultibandCompressor.ts#L40)
...
- Dispose and disconnect
  ...
  - Defined in [Tone/component/dynamics/MultibandCompressor.ts:134](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/MultibandCompressor.ts#L134)
...
- get(): [MultibandCompressorOptions](../interfaces/MultibandCompressorOptions.md)

- Get the object's attributes.

  #### Returns [MultibandCompressorOptions](../interfaces/MultibandCompressorOptions.md)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[MultibandCompressorOptions](../interfaces/MultibandCompressorOptions.md)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](MultibandCompressor.md#toDestination)
...
- getDefaults(): [MultibandCompressorOptions](../interfaces/MultibandCompressorOptions.md)

- #### Returns [MultibandCompressorOptions](../interfaces/MultibandCompressorOptions.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[getDefaults](ToneAudioNode.md#getDefaults)

  - Defined in [Tone/component/dynamics/MultibandCompressor.ts:106](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/MultibandCompressor.ts#L106)
