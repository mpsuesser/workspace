...
A one pole filter with 6db-per-octave rolloff. Either "highpass" or "lowpass". Note that changing the type or frequency may result in a discontinuity which can sound like a click or pop. References:

- <http://www.earlevel.com/main/2012/12/15/a-one-pole-filter/>
- <http://www.dspguide.com/ch19/2.htm>
- <https://github.com/vitaliy-bobrov/js-rocks/blob/master/src/app/audio/effects/one-pole-filters.ts>

#### Hierarchy ([view full](../hierarchy.md#OnePoleFilter))

- [ToneAudioNode](ToneAudioNode.md)<[OnePoleFilterOptions](../interfaces/OnePoleFilterOptions.md)>
  - OnePoleFilter

- Defined in [Tone/component/filter/OnePoleFilter.ts:26](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/OnePoleFilter.ts#L26)

## Constructors

### constructor

- new OnePoleFilter(frequency?, type?): [OnePoleFilter](OnePoleFilter.md)

- #### Parameters

  - `Optional` frequency: [Unit](../modules/Unit.md).[Frequency](../types/Unit.Frequency.md)
    The frequency
  - `Optional` type: [OnePoleFilterType](../types/OnePoleFilterType.md)
    The filter type, either "lowpass" or "highpass"

  #### Returns [OnePoleFilter](OnePoleFilter.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/component/filter/OnePoleFilter.ts:51](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/OnePoleFilter.ts#L51)

- new OnePoleFilter(options?): [OnePoleFilter](OnePoleFilter.md)

- #### Parameters

  - `Optional` options: Partial<[OnePoleFilterOptions](../interfaces/OnePoleFilterOptions.md)>

  #### Returns [OnePoleFilter](OnePoleFilter.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/component/filter/OnePoleFilter.ts:52](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/OnePoleFilter.ts#L52)
...
- Defined in [Tone/component/filter/OnePoleFilter.ts:44](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/OnePoleFilter.ts#L44)

### `Readonly` name

name: string = "OnePoleFilter"

The name of the class

Overrides [ToneAudioNode](ToneAudioNode.md).[name](ToneAudioNode.md#name)

- Defined in [Tone/component/filter/OnePoleFilter.ts:27](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/OnePoleFilter.ts#L27)
...
- Defined in [Tone/component/filter/OnePoleFilter.ts:45](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/OnePoleFilter.ts#L45)
...
- get frequency(): [Unit](../modules/Unit.md).[Frequency](../types/Unit.Frequency.md)

- The frequency value.

  #### Returns [Unit](../modules/Unit.md).[Frequency](../types/Unit.Frequency.md)

  - Defined in [Tone/component/filter/OnePoleFilter.ts:106](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/OnePoleFilter.ts#L106)

- set frequency(fq): void
...
- #### Parameters
  ...
  - Defined in [Tone/component/filter/OnePoleFilter.ts:109](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/OnePoleFilter.ts#L109)
...
- get type(): [OnePoleFilterType](../types/OnePoleFilterType.md)

- The OnePole Filter type, either "highpass" or "lowpass"

  #### Returns [OnePoleFilterType](../types/OnePoleFilterType.md)

  - Defined in [Tone/component/filter/OnePoleFilter.ts:117](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/OnePoleFilter.ts#L117)

- set type(t): void

- #### Parameters

  - t: [OnePoleFilterType](../types/OnePoleFilterType.md)

  #### Returns void

  - Defined in [Tone/component/filter/OnePoleFilter.ts:120](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/OnePoleFilter.ts#L120)
...
- Dispose and disconnect
  ...
  - Defined in [Tone/component/filter/OnePoleFilter.ts:144](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/OnePoleFilter.ts#L144)
...
- get(): [OnePoleFilterOptions](../interfaces/OnePoleFilterOptions.md)

- Get the object's attributes.

  #### Returns [OnePoleFilterOptions](../interfaces/OnePoleFilterOptions.md)
...
- Get the frequency response curve. This curve represents how the filter responses to frequencies between 20hz-20khz.
  ...
  - Defined in [Tone/component/filter/OnePoleFilter.ts:131](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/OnePoleFilter.ts#L131)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[OnePoleFilterOptions](../interfaces/OnePoleFilterOptions.md)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](OnePoleFilter.md#toDestination)
...
- getDefaults(): [OnePoleFilterOptions](../interfaces/OnePoleFilterOptions.md)

- #### Returns [OnePoleFilterOptions](../interfaces/OnePoleFilterOptions.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[getDefaults](ToneAudioNode.md#getDefaults)

  - Defined in [Tone/component/filter/OnePoleFilter.ts:68](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/OnePoleFilter.ts#L68)
