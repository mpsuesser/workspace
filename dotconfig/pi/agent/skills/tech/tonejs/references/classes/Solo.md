...
Solo lets you isolate a specific audio stream. When an instance is set to `solo=true`, it will mute all other instances of Solo.
...
#### Hierarchy ([view full](../hierarchy.md#Solo))

- [ToneAudioNode](ToneAudioNode.md)<[SoloOptions](../interfaces/SoloOptions.md)>
  - Solo

- Defined in [Tone/component/channel/Solo.ts:25](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Solo.ts#L25)

## Constructors

### constructor

- new Solo(solo?): [Solo](Solo.md)
...
- #### Parameters
  ...
  #### Returns [Solo](Solo.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/component/channel/Solo.ts:34](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Solo.ts#L34)

- new Solo(options?): [Solo](Solo.md)

- #### Parameters

  - `Optional` options: Partial<[SoloOptions](../interfaces/SoloOptions.md)>

  #### Returns [Solo](Solo.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/component/channel/Solo.ts:35](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Solo.ts#L35)
...
- Defined in [Tone/component/channel/Solo.ts:28](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Solo.ts#L28)
...
- Defined in [Tone/component/channel/Solo.ts:26](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Solo.ts#L26)
...
- Defined in [Tone/component/channel/Solo.ts:29](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Solo.ts#L29)
...
- If the current instance is muted, i.e. another instance is soloed
  ...
  - Defined in [Tone/component/channel/Solo.ts:93](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Solo.ts#L93)
...
- Isolates this instance and mutes all other instances of Solo. Only one instance can be soloed at a time. A soloed instance will report `solo=false` when another instance is soloed.

  #### Returns boolean

  - Defined in [Tone/component/channel/Solo.ts:76](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Solo.ts#L76)
...
- #### Parameters
  ...
  - Defined in [Tone/component/channel/Solo.ts:79](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Solo.ts#L79)
...
- Dispose and disconnect
  ...
  - Defined in [Tone/component/channel/Solo.ts:153](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Solo.ts#L153)
...
- get(): [SoloOptions](../interfaces/SoloOptions.md)

- Get the object's attributes.

  #### Returns [SoloOptions](../interfaces/SoloOptions.md)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[SoloOptions](../interfaces/SoloOptions.md)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](Solo.md#toDestination)
...
- getDefaults(): [SoloOptions](../interfaces/SoloOptions.md)

- #### Returns [SoloOptions](../interfaces/SoloOptions.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[getDefaults](ToneAudioNode.md#getDefaults)

  - Defined in [Tone/component/channel/Solo.ts:55](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Solo.ts#L55)
