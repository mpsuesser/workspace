...
- Effect<[ChebyshevOptions](../interfaces/ChebyshevOptions.md)>
  - Chebyshev

- Defined in [Tone/effect/Chebyshev.ts:26](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Chebyshev.ts#L26)

## Constructors

### constructor

- new Chebyshev(order?): [Chebyshev](Chebyshev.md)
...
- #### Parameters
  ...
  #### Returns [Chebyshev](Chebyshev.md)

  Overrides Effect<ChebyshevOptions>.constructor

  - Defined in [Tone/effect/Chebyshev.ts:42](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Chebyshev.ts#L42)

- new Chebyshev(options?): [Chebyshev](Chebyshev.md)

- #### Parameters

  - `Optional` options: Partial<[ChebyshevOptions](../interfaces/ChebyshevOptions.md)>

  #### Returns [Chebyshev](Chebyshev.md)

  Overrides Effect<ChebyshevOptions>.constructor

  - Defined in [Tone/effect/Chebyshev.ts:43](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Chebyshev.ts#L43)
...
name: string = "Chebyshev"

Overrides Effect.name

- Defined in [Tone/effect/Chebyshev.ts:27](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Chebyshev.ts#L27)
...
- The order of the Chebyshev polynomial which creates the equation which is applied to the incoming signal through a Tone.WaveShaper. Must be an integer. The equations are in the form:
  ...
  - Defined in [Tone/effect/Chebyshev.ts:107](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Chebyshev.ts#L107)
...
- #### Parameters
  ...
  - Defined in [Tone/effect/Chebyshev.ts:110](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Chebyshev.ts#L110)
...
- The oversampling of the effect. Can either be "none", "2x" or "4x".
  ...
  - Defined in [Tone/effect/Chebyshev.ts:121](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Chebyshev.ts#L121)
...
- #### Parameters
  ...
  - Defined in [Tone/effect/Chebyshev.ts:124](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Chebyshev.ts#L124)
...
- #### Returns this
  ...
  - Defined in [Tone/effect/Chebyshev.ts:128](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Chebyshev.ts#L128)
...
- get(): [ChebyshevOptions](../interfaces/ChebyshevOptions.md)

- Get the object's attributes.

  #### Returns [ChebyshevOptions](../interfaces/ChebyshevOptions.md)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[ChebyshevOptions](../interfaces/ChebyshevOptions.md)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](Chebyshev.md#toDestination)
...
- getDefaults(): [ChebyshevOptions](../interfaces/ChebyshevOptions.md)

- #### Returns [ChebyshevOptions](../interfaces/ChebyshevOptions.md)

  Overrides Effect.getDefaults

  - Defined in [Tone/effect/Chebyshev.ts:63](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Chebyshev.ts#L63)
