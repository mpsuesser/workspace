...
DuoSynth is a monophonic synth composed of two [MonoSynth](MonoSynth.md)s run in parallel with control over the frequency ratio between the two voices and vibrato effect.
...
- Monophonic<[DuoSynthOptions](../interfaces/DuoSynthOptions.md)>
  - DuoSynth

- Defined in [Tone/instrument/DuoSynth.ts:38](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/DuoSynth.ts#L38)

## Constructors

### constructor

- new DuoSynth(options?): [DuoSynth](DuoSynth.md)

- #### Parameters

  - `Optional` options: RecursivePartial<[DuoSynthOptions](../interfaces/DuoSynthOptions.md)>

  #### Returns [DuoSynth](DuoSynth.md)

  Overrides Monophonic<DuoSynthOptions>.constructor

  - Defined in [Tone/instrument/DuoSynth.ts:85](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/DuoSynth.ts#L85)
...
- Defined in [Tone/instrument/DuoSynth.ts:42](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/DuoSynth.ts#L42)
...
- Defined in [Tone/instrument/DuoSynth.ts:41](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/DuoSynth.ts#L41)
...
- Defined in [Tone/instrument/DuoSynth.ts:73](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/DuoSynth.ts#L73)
...
- Defined in [Tone/instrument/DuoSynth.ts:39](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/DuoSynth.ts#L39)
...
vibratoAmount: [Param](Param.md)<"normalRange">

The amount of vibrato

- Defined in [Tone/instrument/DuoSynth.ts:57](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/DuoSynth.ts#L57)

### vibratoRate

vibratoRate: [Signal](Signal.md)<"frequency">

the vibrato frequency

- Defined in [Tone/instrument/DuoSynth.ts:62](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/DuoSynth.ts#L62)

### `Readonly` voice0

voice0: [MonoSynth](MonoSynth.md)

the first voice

- Defined in [Tone/instrument/DuoSynth.ts:47](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/DuoSynth.ts#L47)

### `Readonly` voice1

voice1: [MonoSynth](MonoSynth.md)

the second voice

- Defined in [Tone/instrument/DuoSynth.ts:52](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/DuoSynth.ts#L52)
...
- #### Returns this
  ...
  - Defined in [Tone/instrument/DuoSynth.ts:232](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/DuoSynth.ts#L232)
...
- get(): [DuoSynthOptions](../interfaces/DuoSynthOptions.md)

- Get the object's attributes.

  #### Returns [DuoSynthOptions](../interfaces/DuoSynthOptions.md)
...
- #### Parameters
  ...
  - Defined in [Tone/instrument/DuoSynth.ts:156](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/DuoSynth.ts#L156)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[DuoSynthOptions](../interfaces/DuoSynthOptions.md)>
...
- Sync the instrument to the Transport. All subsequent calls of [triggerAttack](DuoSynth.md#triggerAttack) and [triggerRelease](DuoSynth.md#triggerRelease) will be scheduled along the transport.
...
- Connect the output to the context's destination node.
  ...
  [toDestination](DuoSynth.md#toDestination)
...
- getDefaults(): [DuoSynthOptions](../interfaces/DuoSynthOptions.md)

- #### Returns [DuoSynthOptions](../interfaces/DuoSynthOptions.md)

  Overrides Monophonic.getDefaults

  - Defined in [Tone/instrument/DuoSynth.ts:164](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/DuoSynth.ts#L164)
