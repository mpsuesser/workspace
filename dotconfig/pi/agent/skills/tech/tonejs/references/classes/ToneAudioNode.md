# Class ToneAudioNode<Options>`Abstract`

ToneAudioNode is the base class for classes which process audio.

#### Type Parameters

- Options extends [ToneAudioNodeOptions](../types/ToneAudioNodeOptions.md) = [ToneAudioNodeOptions](../types/ToneAudioNodeOptions.md)

#### Hierarchy ([view full](../hierarchy.md#ToneAudioNode))

- ToneWithContext<[Options](ToneAudioNode.md#constructor.new_ToneAudioNode.Options-1)>
  - ToneAudioNode
    - [Delay](Delay.md)
    - [Gain](Gain.md)
    - [UserMedia](UserMedia.md)
    - [LFO](LFO.md)
    - [Players](Players.md)
    - [Signal](Signal.md)
    ...
    - [Merge](Merge.md)
    - [MidSideMerge](MidSideMerge.md)
    - [MidSideSplit](MidSideSplit.md)
    - [Mono](Mono.md)
    - [MultibandSplit](MultibandSplit.md)
    - [Panner](Panner.md)
    ...
    - [Gate](Gate.md)
    - [Limiter](Limiter.md)
    - [MidSideCompressor](MidSideCompressor.md)
    - [MultibandCompressor](MultibandCompressor.md)
    - [Envelope](Envelope.md)
    - [EQ3](EQ3.md)
    - [Filter](Filter.md)
    - [OnePoleFilter](OnePoleFilter.md)
    - [LowpassCombFilter](LowpassCombFilter.md)
    - [Convolver](Convolver.md)
    - [BiquadFilter](BiquadFilter.md)

- Defined in [Tone/core/context/ToneAudioNode.ts:25](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/core/context/ToneAudioNode.ts#L25)

## Constructors

### constructor

- new ToneAudioNode<[Options](ToneAudioNode.md#constructor.new_ToneAudioNode.Options-1)>(context?): [ToneAudioNode](ToneAudioNode.md)<[Options](ToneAudioNode.md#constructor.new_ToneAudioNode.Options-1)>

- Pass in a constructor as the first argument

  #### Type Parameters

  - Options extends ToneWithContextOptions = ToneWithContextOptions

  #### Parameters

  - `Optional` context: [BaseContext](BaseContext.md)

  #### Returns [ToneAudioNode](ToneAudioNode.md)<[Options](ToneAudioNode.md#constructor.new_ToneAudioNode.Options-1)>

  Inherited from ToneWithContext<Options>.constructor

  - Defined in [Tone/core/context/ToneWithContext.ts:52](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/core/context/ToneWithContext.ts#L52)

- new ToneAudioNode<[Options](ToneAudioNode.md#constructor.new_ToneAudioNode-1.Options-2)>(options?): [ToneAudioNode](ToneAudioNode.md)<[Options](ToneAudioNode.md#constructor.new_ToneAudioNode.Options-1)>
...
- #### Type Parameters
  ...
  - `Optional` options: Partial<ToneWithContextOptions>

  #### Returns [ToneAudioNode](ToneAudioNode.md)<[Options](ToneAudioNode.md#constructor.new_ToneAudioNode.Options-1)>

  Inherited from ToneWithContext<Options>.constructor

  - Defined in [Tone/core/context/ToneWithContext.ts:53](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/core/context/ToneWithContext.ts#L53)
...
input: undefined \| [InputNode](../types/InputNode.md)

The input node or nodes. If the object is a source, it does not have any input and this.input is undefined.

- Defined in [Tone/core/context/ToneAudioNode.ts:37](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/core/context/ToneAudioNode.ts#L37)
...
- Defined in [Tone/core/context/ToneAudioNode.ts:31](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/core/context/ToneAudioNode.ts#L31)

### `Abstract` output

output: undefined \| [OutputNode](../types/OutputNode.md)

The output nodes. If the object is a sink, it does not have any output and this.output is undefined.

- Defined in [Tone/core/context/ToneAudioNode.ts:43](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/core/context/ToneAudioNode.ts#L43)
...
- Dispose and disconnect
  ...
  - Defined in [Tone/core/context/ToneAudioNode.ts:272](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/core/context/ToneAudioNode.ts#L272)
...
- get(): [Options](ToneAudioNode.md#constructor.new_ToneAudioNode.Options-1)

- Get the object's attributes.

  #### Returns [Options](ToneAudioNode.md#constructor.new_ToneAudioNode.Options-1)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[Options](ToneAudioNode.md#constructor.new_ToneAudioNode.Options-1)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](ToneAudioNode.md#toDestination)
...
- #### Returns ToneWithContextOptions
  ...
  Inherited from ToneWithContext.getDefaults

  - Defined in [Tone/core/context/ToneWithContext.ts:68](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/core/context/ToneWithContext.ts#L68)
