...
#### Hierarchy ([view full](../hierarchy.md#SyncedSignal))

- [Signal](Signal.md)<[TypeName](SyncedSignal.md#constructor.new_SyncedSignal.TypeName-1)>
  - SyncedSignal

- Defined in [Tone/signal/SyncedSignal.ts:20](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/SyncedSignal.ts#L20)

## Constructors

### constructor

- new SyncedSignal<[TypeName](SyncedSignal.md#constructor.new_SyncedSignal.TypeName-1)>(value?, units?): [SyncedSignal](SyncedSignal.md)<[TypeName](SyncedSignal.md#constructor.new_SyncedSignal.TypeName-1)>
...
- #### Type Parameters
  ...
  - `Optional` value: [UnitMap](../interfaces/Unit.UnitMap.md)\[[TypeName](SyncedSignal.md#constructor.new_SyncedSignal.TypeName-1)\]
    Initial value of the signal
  - `Optional` units: [TypeName](SyncedSignal.md#constructor.new_SyncedSignal.TypeName-1)
    The unit name, e.g. "frequency"

  #### Returns [SyncedSignal](SyncedSignal.md)<[TypeName](SyncedSignal.md#constructor.new_SyncedSignal.TypeName-1)>

  Overrides [Signal](Signal.md).[constructor](Signal.md#constructor)

  - Defined in [Tone/signal/SyncedSignal.ts:51](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/SyncedSignal.ts#L51)

- new SyncedSignal<[TypeName](SyncedSignal.md#constructor.new_SyncedSignal-1.TypeName-2)>(options?): [SyncedSignal](SyncedSignal.md)<[TypeName](SyncedSignal.md#constructor.new_SyncedSignal.TypeName-1)>
...
- #### Type Parameters
  ...
  - `Optional` options: Partial<[SignalOptions](../interfaces/SignalOptions.md)<[TypeName](SyncedSignal.md#constructor.new_SyncedSignal.TypeName-1)>>

  #### Returns [SyncedSignal](SyncedSignal.md)<[TypeName](SyncedSignal.md#constructor.new_SyncedSignal.TypeName-1)>

  Overrides [Signal](Signal.md).[constructor](Signal.md#constructor)

  - Defined in [Tone/signal/SyncedSignal.ts:52](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/SyncedSignal.ts#L52)
...
Inherited from [Signal](Signal.md).[input](Signal.md#input)
...
name: string = "SyncedSignal"

The name of the class

Overrides [Signal](Signal.md).[name](Signal.md#name)

- Defined in [Tone/signal/SyncedSignal.ts:23](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/SyncedSignal.ts#L23)
...
- Defined in [Tone/signal/SyncedSignal.ts:30](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/SyncedSignal.ts#L30)
...
- Defined in [Tone/signal/SyncedSignal.ts:28](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/SyncedSignal.ts#L28)
...
- #### Parameters
  ...
  Overrides [Signal](Signal.md).[cancelAndHoldAtTime](Signal.md#cancelAndHoldAtTime)

  - Defined in [Tone/signal/SyncedSignal.ts:181](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/SyncedSignal.ts#L181)

### cancelScheduledValues

- cancelScheduledValues(startTime): this
...
- #### Parameters
  ...
  Overrides [Signal](Signal.md).[cancelScheduledValues](Signal.md#cancelScheduledValues)

  - Defined in [Tone/signal/SyncedSignal.ts:157](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/SyncedSignal.ts#L157)
...
- Dispose and disconnect
  ...
  - Defined in [Tone/signal/SyncedSignal.ts:238](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/SyncedSignal.ts#L238)
...
- #### Parameters
  ...
  - value: [UnitMap](../interfaces/Unit.UnitMap.md)\[[TypeName](SyncedSignal.md#constructor.new_SyncedSignal.TypeName-1)\]
  - time: [Unit](../modules/Unit.md).[Time](../types/Unit.Time.md)
...
- #### Parameters
  ...
  Overrides [Signal](Signal.md).[exponentialRampTo](Signal.md#exponentialRampTo)

  - Defined in [Tone/signal/SyncedSignal.ts:199](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/SyncedSignal.ts#L199)

### exponentialRampToValueAtTime

- exponentialRampToValueAtTime(value, time): [SyncedSignal](SyncedSignal.md)<[TypeName](SyncedSignal.md#constructor.new_SyncedSignal.TypeName-1)>
...
- #### Parameters
  ...
  Overrides [Signal](Signal.md).[exponentialRampToValueAtTime](Signal.md#exponentialRampToValueAtTime)

  - Defined in [Tone/signal/SyncedSignal.ts:132](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/SyncedSignal.ts#L132)
...
- getValueAtTime(time): [UnitMap](../interfaces/Unit.UnitMap.md)\[[TypeName](SyncedSignal.md#constructor.new_SyncedSignal.TypeName-1)\]

- #### Parameters

  - time: [Unit](../modules/Unit.md).[Time](../types/Unit.Time.md)

  #### Returns [UnitMap](../interfaces/Unit.UnitMap.md)\[[TypeName](SyncedSignal.md#constructor.new_SyncedSignal.TypeName-1)\]

  Overrides [Signal](Signal.md).[getValueAtTime](Signal.md#getValueAtTime)

  - Defined in [Tone/signal/SyncedSignal.ts:106](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/SyncedSignal.ts#L106)
...
- #### Parameters
  ...
  Overrides [Signal](Signal.md).[linearRampTo](Signal.md#linearRampTo)

  - Defined in [Tone/signal/SyncedSignal.ts:212](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/SyncedSignal.ts#L212)

### linearRampToValueAtTime

- linearRampToValueAtTime(value, time): [SyncedSignal](SyncedSignal.md)<[TypeName](SyncedSignal.md#constructor.new_SyncedSignal.TypeName-1)>
...
- #### Parameters
  ...
  Overrides [Signal](Signal.md).[linearRampToValueAtTime](Signal.md#linearRampToValueAtTime)

  - Defined in [Tone/signal/SyncedSignal.ts:123](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/SyncedSignal.ts#L123)
...
- #### Parameters
  ...
  Overrides [Signal](Signal.md).[setRampPoint](Signal.md#setRampPoint)

  - Defined in [Tone/signal/SyncedSignal.ts:190](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/SyncedSignal.ts#L190)
...
- #### Parameters
  ...
  Overrides [Signal](Signal.md).[setTargetAtTime](Signal.md#setTargetAtTime)

  - Defined in [Tone/signal/SyncedSignal.ts:144](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/SyncedSignal.ts#L144)

### setValueAtTime

- setValueAtTime(value, time): [SyncedSignal](SyncedSignal.md)<[TypeName](SyncedSignal.md#constructor.new_SyncedSignal.TypeName-1)>
...
- #### Parameters
  ...
  Overrides [Signal](Signal.md).[setValueAtTime](Signal.md#setValueAtTime)

  - Defined in [Tone/signal/SyncedSignal.ts:114](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/SyncedSignal.ts#L114)
...
- #### Parameters
  ...
  - values: [UnitMap](../interfaces/Unit.UnitMap.md)\[[TypeName](SyncedSignal.md#constructor.new_SyncedSignal.TypeName-1)\]\[\]
  - startTime: [Unit](../modules/Unit.md).[Time](../types/Unit.Time.md)
  ...
  Overrides [Signal](Signal.md).[setValueCurveAtTime](Signal.md#setValueCurveAtTime)

  - Defined in [Tone/signal/SyncedSignal.ts:166](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/SyncedSignal.ts#L166)
...
- #### Parameters
  ...
  Overrides [Signal](Signal.md).[targetRampTo](Signal.md#targetRampTo)

  - Defined in [Tone/signal/SyncedSignal.ts:225](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/SyncedSignal.ts#L225)
...
- Connect the output to the context's destination node.
  ...
  [toDestination](SyncedSignal.md#toDestination)
...
- #### Returns [SignalOptions](../interfaces/SignalOptions.md)<any>
  ...
  Inherited from [Signal](Signal.md).[getDefaults](Signal.md#getDefaults)
