...
#### Hierarchy ([view full](../hierarchy.md#AmplitudeEnvelope))

- [Envelope](Envelope.md)
  - AmplitudeEnvelope

- Defined in [Tone/component/envelope/AmplitudeEnvelope.ts:28](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/envelope/AmplitudeEnvelope.ts#L28)

## Constructors

### constructor

- new AmplitudeEnvelope(attack?, decay?, sustain?, release?): [AmplitudeEnvelope](AmplitudeEnvelope.md)
...
- #### Parameters
  ...
  #### Returns [AmplitudeEnvelope](AmplitudeEnvelope.md)

  Overrides [Envelope](Envelope.md).[constructor](Envelope.md#constructor)

  - Defined in [Tone/component/envelope/AmplitudeEnvelope.ts:47](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/envelope/AmplitudeEnvelope.ts#L47)

- new AmplitudeEnvelope(options?): [AmplitudeEnvelope](AmplitudeEnvelope.md)

- #### Parameters

  - `Optional` options: Partial<[EnvelopeOptions](../interfaces/EnvelopeOptions.md)>

  #### Returns [AmplitudeEnvelope](AmplitudeEnvelope.md)

  Overrides [Envelope](Envelope.md).[constructor](Envelope.md#constructor)

  - Defined in [Tone/component/envelope/AmplitudeEnvelope.ts:53](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/envelope/AmplitudeEnvelope.ts#L53)
...
Overrides [Envelope](Envelope.md).[input](Envelope.md#input)

- Defined in [Tone/component/envelope/AmplitudeEnvelope.ts:36](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/envelope/AmplitudeEnvelope.ts#L36)
...
- Defined in [Tone/component/envelope/AmplitudeEnvelope.ts:29](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/envelope/AmplitudeEnvelope.ts#L29)
...
Overrides [Envelope](Envelope.md).[output](Envelope.md#output)

- Defined in [Tone/component/envelope/AmplitudeEnvelope.ts:35](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/envelope/AmplitudeEnvelope.ts#L35)
...
- Clean up
  ...
  - Defined in [Tone/component/envelope/AmplitudeEnvelope.ts:71](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/envelope/AmplitudeEnvelope.ts#L71)
...
- Connect the output to the context's destination node.
  ...
  [toDestination](AmplitudeEnvelope.md#toDestination)
...
- getDefaults(): [EnvelopeOptions](../interfaces/EnvelopeOptions.md)

- #### Returns [EnvelopeOptions](../interfaces/EnvelopeOptions.md)

  Inherited from [Envelope](Envelope.md).[getDefaults](Envelope.md#getDefaults)

  - Defined in [Tone/component/envelope/Envelope.ts:205](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/envelope/Envelope.ts#L205)
