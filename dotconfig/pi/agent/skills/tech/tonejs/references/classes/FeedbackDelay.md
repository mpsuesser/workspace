...
- FeedbackEffect<[FeedbackDelayOptions](../interfaces/FeedbackDelayOptions.md)>
  - FeedbackDelay

- Defined in [Tone/effect/FeedbackDelay.ts:27](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/FeedbackDelay.ts#L27)

## Constructors

### constructor

- new FeedbackDelay(delayTime?, feedback?): [FeedbackDelay](FeedbackDelay.md)
...
- #### Parameters
  ...
  #### Returns [FeedbackDelay](FeedbackDelay.md)

  Overrides FeedbackEffect<FeedbackDelayOptions>.constructor

  - Defined in [Tone/effect/FeedbackDelay.ts:40](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/FeedbackDelay.ts#L40)

- new FeedbackDelay(options?): [FeedbackDelay](FeedbackDelay.md)

- #### Parameters

  - `Optional` options: Partial<[FeedbackDelayOptions](../interfaces/FeedbackDelayOptions.md)>

  #### Returns [FeedbackDelay](FeedbackDelay.md)

  Overrides FeedbackEffect<FeedbackDelayOptions>.constructor

  - Defined in [Tone/effect/FeedbackDelay.ts:41](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/FeedbackDelay.ts#L41)
...
- Defined in [Tone/effect/FeedbackDelay.ts:38](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/FeedbackDelay.ts#L38)
...
name: string = "FeedbackDelay"

Overrides FeedbackEffect.name

- Defined in [Tone/effect/FeedbackDelay.ts:28](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/FeedbackDelay.ts#L28)
...
- #### Returns this
  ...
  - Defined in [Tone/effect/FeedbackDelay.ts:69](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/FeedbackDelay.ts#L69)
...
- get(): [FeedbackDelayOptions](../interfaces/FeedbackDelayOptions.md)

- Get the object's attributes.

  #### Returns [FeedbackDelayOptions](../interfaces/FeedbackDelayOptions.md)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[FeedbackDelayOptions](../interfaces/FeedbackDelayOptions.md)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](FeedbackDelay.md#toDestination)
...
- getDefaults(): [FeedbackDelayOptions](../interfaces/FeedbackDelayOptions.md)

- #### Returns [FeedbackDelayOptions](../interfaces/FeedbackDelayOptions.md)

  Overrides FeedbackEffect.getDefaults

  - Defined in [Tone/effect/FeedbackDelay.ts:62](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/FeedbackDelay.ts#L62)
