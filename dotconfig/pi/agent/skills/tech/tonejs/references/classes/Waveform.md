...
- MeterBase<[WaveformOptions](../interfaces/WaveformOptions.md)>
  - Waveform

- Defined in [Tone/component/analysis/Waveform.ts:16](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Waveform.ts#L16)

## Constructors

### constructor

- new Waveform(size?): [Waveform](Waveform.md)
...
- #### Parameters
  ...
  #### Returns [Waveform](Waveform.md)

  Overrides MeterBase<WaveformOptions>.constructor

  - Defined in [Tone/component/analysis/Waveform.ts:22](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Waveform.ts#L22)

- new Waveform(options?): [Waveform](Waveform.md)

- #### Parameters

  - `Optional` options: Partial<[WaveformOptions](../interfaces/WaveformOptions.md)>

  #### Returns [Waveform](Waveform.md)

  Overrides MeterBase<WaveformOptions>.constructor

  - Defined in [Tone/component/analysis/Waveform.ts:23](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Waveform.ts#L23)
...
- Defined in [Tone/component/analysis/Waveform.ts:17](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Waveform.ts#L17)
...
- The size of analysis. This must be a power of two in the range 16 to 16384. Determines the size of the array returned by [getValue](Waveform.md#getValue).

  #### Returns number

  - Defined in [Tone/component/analysis/Waveform.ts:54](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Waveform.ts#L54)
...
- #### Parameters
  ...
  - Defined in [Tone/component/analysis/Waveform.ts:57](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Waveform.ts#L57)
...
- get(): [WaveformOptions](../interfaces/WaveformOptions.md)

- Get the object's attributes.

  #### Returns [WaveformOptions](../interfaces/WaveformOptions.md)
...
- Return the waveform for the current time as a Float32Array where each value in the array represents a sample in the waveform.
  ...
  - Defined in [Tone/component/analysis/Waveform.ts:46](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Waveform.ts#L46)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[WaveformOptions](../interfaces/WaveformOptions.md)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](Waveform.md#toDestination)
...
- getDefaults(): [WaveformOptions](../interfaces/WaveformOptions.md)

- #### Returns [WaveformOptions](../interfaces/WaveformOptions.md)

  Overrides MeterBase.getDefaults

  - Defined in [Tone/component/analysis/Waveform.ts:36](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Waveform.ts#L36)
