...
In [Part 2](./part-2.md) you deployed a Worker with R2 Bucket bindings. Now you'll write integration tests that deploy the stack, hit the live Worker over HTTP, and verify it works.
...
In [Part 4](./part-4.md), you'll run your stack locally with `alchemy dev` for instant feedback during development.
