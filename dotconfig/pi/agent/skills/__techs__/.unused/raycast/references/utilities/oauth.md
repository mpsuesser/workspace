...
1. Authenticating with a service using [OAuthService](oauth/oauthservice.md) or built-in providers (e.g GitHub with `OAuthService.github`)
2. Bringing authentication to Raycast commands using [withAccessToken](oauth/withaccesstoken.md) and [`getAccessToken`](oauth/getaccesstoken.md)
...
You can see our different providers on the following page: [OAuthService](oauth/oauthservice.md)
