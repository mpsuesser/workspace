...
- StereoEffect<[JCReverbOptions](../interfaces/JCReverbOptions.md)>
  - JCReverb

- Defined in [Tone/effect/JCReverb.ts:47](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/JCReverb.ts#L47)

## Constructors

### constructor

- new JCReverb(roomSize?): [JCReverb](JCReverb.md)
...
- #### Parameters
  ...
  #### Returns [JCReverb](JCReverb.md)

  Overrides StereoEffect<JCReverbOptions>.constructor

  - Defined in [Tone/effect/JCReverb.ts:73](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/JCReverb.ts#L73)

- new JCReverb(options?): [JCReverb](JCReverb.md)

- #### Parameters

  - `Optional` options: Partial<[JCReverbOptions](../interfaces/JCReverbOptions.md)>

  #### Returns [JCReverb](JCReverb.md)

  Overrides StereoEffect<JCReverbOptions>.constructor

  - Defined in [Tone/effect/JCReverb.ts:74](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/JCReverb.ts#L74)
...
name: string = "JCReverb"

Overrides StereoEffect.name

- Defined in [Tone/effect/JCReverb.ts:48](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/JCReverb.ts#L48)
...
- Defined in [Tone/effect/JCReverb.ts:53](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/JCReverb.ts#L53)
...
- #### Returns this
  ...
  - Defined in [Tone/effect/JCReverb.ts:131](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/JCReverb.ts#L131)
...
- get(): [JCReverbOptions](../interfaces/JCReverbOptions.md)

- Get the object's attributes.

  #### Returns [JCReverbOptions](../interfaces/JCReverbOptions.md)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[JCReverbOptions](../interfaces/JCReverbOptions.md)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](JCReverb.md#toDestination)
...
- getDefaults(): [JCReverbOptions](../interfaces/JCReverbOptions.md)

- #### Returns [JCReverbOptions](../interfaces/JCReverbOptions.md)

  Overrides StereoEffect.getDefaults

  - Defined in [Tone/effect/JCReverb.ts:125](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/JCReverb.ts#L125)
