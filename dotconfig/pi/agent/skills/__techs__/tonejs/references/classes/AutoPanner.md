...
AutoPanner is a [Panner](Panner.md) with an [LFO](LFO.md) connected to the pan amount. [Related Reading](https://www.ableton.com/en/blog/autopan-chopper-effect-and-more-liveschool/).
...
- LFOEffect<[AutoPannerOptions](../interfaces/AutoPannerOptions.md)>
  - AutoPanner

- Defined in [Tone/effect/AutoPanner.ts:21](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/AutoPanner.ts#L21)

## Constructors

### constructor

- new AutoPanner(frequency?): [AutoPanner](AutoPanner.md)
...
- #### Parameters
  ...
  #### Returns [AutoPanner](AutoPanner.md)

  Overrides LFOEffect<AutoPannerOptions>.constructor

  - Defined in [Tone/effect/AutoPanner.ts:32](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/AutoPanner.ts#L32)

- new AutoPanner(options?): [AutoPanner](AutoPanner.md)

- #### Parameters

  - `Optional` options: Partial<[AutoPannerOptions](../interfaces/AutoPannerOptions.md)>

  #### Returns [AutoPanner](AutoPanner.md)

  Overrides LFOEffect<AutoPannerOptions>.constructor

  - Defined in [Tone/effect/AutoPanner.ts:33](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/AutoPanner.ts#L33)

## Properties

### `Readonly` \_panner

\_panner: [Panner](Panner.md)

The filter node

- Defined in [Tone/effect/AutoPanner.ts:27](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/AutoPanner.ts#L27)
...
name: string = "AutoPanner"

Overrides LFOEffect.name

- Defined in [Tone/effect/AutoPanner.ts:22](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/AutoPanner.ts#L22)
...
- #### Returns this
  ...
  - Defined in [Tone/effect/AutoPanner.ts:59](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/AutoPanner.ts#L59)
...
- get(): [AutoPannerOptions](../interfaces/AutoPannerOptions.md)

- Get the object's attributes.

  #### Returns [AutoPannerOptions](../interfaces/AutoPannerOptions.md)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[AutoPannerOptions](../interfaces/AutoPannerOptions.md)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](AutoPanner.md#toDestination)
...
- getDefaults(): [AutoPannerOptions](../interfaces/AutoPannerOptions.md)

- #### Returns [AutoPannerOptions](../interfaces/AutoPannerOptions.md)

  Overrides LFOEffect.getDefaults

  - Defined in [Tone/effect/AutoPanner.ts:53](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/AutoPanner.ts#L53)
