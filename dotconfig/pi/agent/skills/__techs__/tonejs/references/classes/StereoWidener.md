...
- MidSideEffect<[StereoWidenerOptions](../interfaces/StereoWidenerOptions.md)>
  - StereoWidener

- Defined in [Tone/effect/StereoWidener.ts:27](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/StereoWidener.ts#L27)

## Constructors

### constructor

- new StereoWidener(width?): [StereoWidener](StereoWidener.md)
...
- #### Parameters
  ...
  #### Returns [StereoWidener](StereoWidener.md)

  Overrides MidSideEffect<StereoWidenerOptions>.constructor

  - Defined in [Tone/effect/StereoWidener.ts:63](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/StereoWidener.ts#L63)

- new StereoWidener(options?): [StereoWidener](StereoWidener.md)

- #### Parameters

  - `Optional` options: Partial<[StereoWidenerOptions](../interfaces/StereoWidenerOptions.md)>

  #### Returns [StereoWidener](StereoWidener.md)

  Overrides MidSideEffect<StereoWidenerOptions>.constructor

  - Defined in [Tone/effect/StereoWidener.ts:64](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/StereoWidener.ts#L64)
...
Inherited from MidSideEffect.context
...
Inherited from MidSideEffect.debug
...
Inherited from MidSideEffect.input
...
name: string = "StereoWidener"

Overrides MidSideEffect.name

- Defined in [Tone/effect/StereoWidener.ts:28](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/StereoWidener.ts#L28)
...
Inherited from MidSideEffect.output
...
Inherited from MidSideEffect.wet
...
width: [Signal](Signal.md)<"normalRange">

The width control. 0 = 100% mid. 1 = 100% side. 0.5 = no change.

- Defined in [Tone/effect/StereoWidener.ts:33](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/StereoWidener.ts#L33)
...
Inherited from MidSideEffect.version
...
- The number of seconds of 1 processing block (128 samples)
  ...
  Inherited from MidSideEffect.blockTime
...
- channelCount is the number of channels used when up-mixing and down-mixing connections to any inputs to the node. The default value is 2 except for specific nodes where its value is specially determined.
  ...
  Inherited from MidSideEffect.channelCount
...
- channelCountMode determines how channels will be counted when up-mixing and down-mixing connections to any inputs to the node. The default value is "max". This attribute has no effect for nodes with no inputs.
  ...
  Inherited from MidSideEffect.channelCountMode
...
- channelInterpretation determines how individual channels will be treated when up-mixing and down-mixing connections to any inputs to the node. The default value is "speakers".
  ...
  Inherited from MidSideEffect.channelInterpretation
...
- Indicates if the instance was disposed. 'Disposing' an instance means that all of the Web Audio nodes that were created for the instance are disconnected and freed for garbage collection.
  ...
  Inherited from MidSideEffect.disposed
...
- The number of inputs feeding into the AudioNode. For source nodes, this will be 0.
  ...
  Inherited from MidSideEffect.numberOfInputs
...
- The number of outputs of the AudioNode.
  ...
  Inherited from MidSideEffect.numberOfOutputs
...
- The duration in seconds of one sample.
  ...
  Inherited from MidSideEffect.sampleTime
...
- Connect the output of this node to the rest of the nodes in series.
  ...
  Inherited from MidSideEffect.chain
...
- connect the output of a ToneAudioNode to an AudioParam, AudioNode, or ToneAudioNode
  ...
  Inherited from MidSideEffect.connect
...
- disconnect the output
  ...
  Inherited from MidSideEffect.disconnect
...
- #### Returns this
  ...
  Overrides MidSideEffect.dispose

  - Defined in [Tone/effect/StereoWidener.ts:108](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/StereoWidener.ts#L108)
...
- connect the output of this node to the rest of the nodes in parallel.
  ...
  Inherited from MidSideEffect.fan
...
- get(): [StereoWidenerOptions](../interfaces/StereoWidenerOptions.md)

- Get the object's attributes.

  #### Returns [StereoWidenerOptions](../interfaces/StereoWidenerOptions.md)
  ...
  Inherited from MidSideEffect.get
...
- Return the current time of the Context clock without any lookAhead.
  ...
  Inherited from MidSideEffect.immediate
...
- Return the current time of the Context clock plus the lookAhead.
  ...
  Inherited from MidSideEffect.now
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[StereoWidenerOptions](../interfaces/StereoWidenerOptions.md)>
  ...
  Inherited from MidSideEffect.set
...
- Connect the output to the context's destination node.
  ...
  Inherited from MidSideEffect.toDestination
...
- Convert the input to a frequency number
  ...
  Inherited from MidSideEffect.toFrequency
...
- Connect the output to the context's destination node.
  ...
  [toDestination](StereoWidener.md#toDestination)

  #### Deprecated

  Inherited from MidSideEffect.toMaster
...
- Convert the incoming time to seconds. This is calculated against the current TransportClass bpm
  ...
  Inherited from MidSideEffect.toSeconds
...
- Convert the class to a string
  ...
  Inherited from MidSideEffect.toString
...
- Convert the input time into ticks
  ...
  Inherited from MidSideEffect.toTicks
...
- getDefaults(): [StereoWidenerOptions](../interfaces/StereoWidenerOptions.md)

- #### Returns [StereoWidenerOptions](../interfaces/StereoWidenerOptions.md)

  Overrides MidSideEffect.getDefaults

  - Defined in [Tone/effect/StereoWidener.ts:102](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/StereoWidener.ts#L102)
