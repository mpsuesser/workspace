...
- StereoEffect<[FreeverbOptions](../interfaces/FreeverbOptions.md)>
  - Freeverb

- Defined in [Tone/effect/Freeverb.ts:44](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Freeverb.ts#L44)

## Constructors

### constructor

- new Freeverb(roomSize?, dampening?): [Freeverb](Freeverb.md)

- #### Parameters

  - `Optional` roomSize: number
    Correlated to the decay time.
  - `Optional` dampening: [Unit](../modules/Unit.md).[Frequency](../types/Unit.Frequency.md)
    The cutoff frequency of a lowpass filter as part of the reverb.

  #### Returns [Freeverb](Freeverb.md)

  Overrides StereoEffect<FreeverbOptions>.constructor

  - Defined in [Tone/effect/Freeverb.ts:71](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Freeverb.ts#L71)

- new Freeverb(options?): [Freeverb](Freeverb.md)

- #### Parameters

  - `Optional` options: Partial<[FreeverbOptions](../interfaces/FreeverbOptions.md)>

  #### Returns [Freeverb](Freeverb.md)

  Overrides StereoEffect<FreeverbOptions>.constructor

  - Defined in [Tone/effect/Freeverb.ts:72](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Freeverb.ts#L72)
...
name: string = "Freeverb"

Overrides StereoEffect.name

- Defined in [Tone/effect/Freeverb.ts:45](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Freeverb.ts#L45)
...
roomSize: [Signal](Signal.md)<"normalRange">

The roomSize value between 0 and 1. A larger roomSize will result in a longer decay.

- Defined in [Tone/effect/Freeverb.ts:50](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Freeverb.ts#L50)
...
- The amount of dampening of the reverberant signal.
  ...
  - Defined in [Tone/effect/Freeverb.ts:133](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Freeverb.ts#L133)

- set dampening(d): void

- #### Parameters

  - d: [Unit](../modules/Unit.md).[Frequency](../types/Unit.Frequency.md)

  #### Returns void

  - Defined in [Tone/effect/Freeverb.ts:136](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Freeverb.ts#L136)
...
- #### Returns this
  ...
  - Defined in [Tone/effect/Freeverb.ts:140](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Freeverb.ts#L140)
...
- get(): [FreeverbOptions](../interfaces/FreeverbOptions.md)

- Get the object's attributes.

  #### Returns [FreeverbOptions](../interfaces/FreeverbOptions.md)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[FreeverbOptions](../interfaces/FreeverbOptions.md)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](Freeverb.md#toDestination)
...
- getDefaults(): [FreeverbOptions](../interfaces/FreeverbOptions.md)

- #### Returns [FreeverbOptions](../interfaces/FreeverbOptions.md)

  Overrides StereoEffect.getDefaults

  - Defined in [Tone/effect/Freeverb.ts:122](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Freeverb.ts#L122)
