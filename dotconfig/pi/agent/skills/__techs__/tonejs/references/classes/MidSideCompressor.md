...
MidSideCompressor applies two different compressors to the [mid](MidSideCompressor.md#mid) and [side](MidSideCompressor.md#side) signal components of the input.

#### See

[MidSideSplit](MidSideSplit.md) and [MidSideMerge](MidSideMerge.md).

#### Hierarchy ([view full](../hierarchy.md#MidSideCompressor))

- [ToneAudioNode](ToneAudioNode.md)<[MidSideCompressorOptions](../interfaces/MidSideCompressorOptions.md)>
  - MidSideCompressor

- Defined in [Tone/component/dynamics/MidSideCompressor.ts:24](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/MidSideCompressor.ts#L24)

## Constructors

### constructor

- new MidSideCompressor(options?): [MidSideCompressor](MidSideCompressor.md)

- #### Parameters

  - `Optional` options: RecursivePartial<[MidSideCompressorOptions](../interfaces/MidSideCompressorOptions.md)>

  #### Returns [MidSideCompressor](MidSideCompressor.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/component/dynamics/MidSideCompressor.ts:50](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/MidSideCompressor.ts#L50)
...
- Defined in [Tone/component/dynamics/MidSideCompressor.ts:27](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/MidSideCompressor.ts#L27)
...
- Defined in [Tone/component/dynamics/MidSideCompressor.ts:43](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/MidSideCompressor.ts#L43)

### `Readonly` name

name: string = "MidSideCompressor"

The name of the class

Overrides [ToneAudioNode](ToneAudioNode.md).[name](ToneAudioNode.md#name)

- Defined in [Tone/component/dynamics/MidSideCompressor.ts:25](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/MidSideCompressor.ts#L25)
...
- Defined in [Tone/component/dynamics/MidSideCompressor.ts:28](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/MidSideCompressor.ts#L28)

### `Readonly` side

side: [Compressor](Compressor.md)

The compression applied to the side signal

- Defined in [Tone/component/dynamics/MidSideCompressor.ts:48](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/MidSideCompressor.ts#L48)
...
- Dispose and disconnect
  ...
  - Defined in [Tone/component/dynamics/MidSideCompressor.ts:95](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/MidSideCompressor.ts#L95)
...
- get(): [MidSideCompressorOptions](../interfaces/MidSideCompressorOptions.md)

- Get the object's attributes.

  #### Returns [MidSideCompressorOptions](../interfaces/MidSideCompressorOptions.md)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[MidSideCompressorOptions](../interfaces/MidSideCompressorOptions.md)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](MidSideCompressor.md#toDestination)
...
- getDefaults(): [MidSideCompressorOptions](../interfaces/MidSideCompressorOptions.md)

- #### Returns [MidSideCompressorOptions](../interfaces/MidSideCompressorOptions.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[getDefaults](ToneAudioNode.md#getDefaults)

  - Defined in [Tone/component/dynamics/MidSideCompressor.ts:76](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/MidSideCompressor.ts#L76)
