...
- LFOEffect<[AutoFilterOptions](../interfaces/AutoFilterOptions.md)>
  - AutoFilter

- Defined in [Tone/effect/AutoFilter.ts:28](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/AutoFilter.ts#L28)

## Constructors

### constructor

- new AutoFilter(frequency?, baseFrequency?, octaves?): [AutoFilter](AutoFilter.md)
...
- #### Parameters
  ...
  #### Returns [AutoFilter](AutoFilter.md)

  Overrides LFOEffect<AutoFilterOptions>.constructor

  - Defined in [Tone/effect/AutoFilter.ts:46](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/AutoFilter.ts#L46)

- new AutoFilter(options?): [AutoFilter](AutoFilter.md)

- #### Parameters

  - `Optional` options: Partial<[AutoFilterOptions](../interfaces/AutoFilterOptions.md)>

  #### Returns [AutoFilter](AutoFilter.md)

  Overrides LFOEffect<AutoFilterOptions>.constructor

  - Defined in [Tone/effect/AutoFilter.ts:51](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/AutoFilter.ts#L51)
...
Inherited from LFOEffect.context
...
Inherited from LFOEffect.debug
...
depth: [Param](Param.md)<"normalRange">

The range of the filter modulating between the min and max frequency. 0 = no modulation. 1 = full modulation.

Inherited from LFOEffect.depth

- Defined in [Tone/effect/LFOEffect.ts:32](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/LFOEffect.ts#L32)
...
- Defined in [Tone/effect/AutoFilter.ts:34](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/AutoFilter.ts#L34)
...
Inherited from LFOEffect.frequency

- Defined in [Tone/effect/LFOEffect.ts:37](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/LFOEffect.ts#L37)
...
Inherited from LFOEffect.input
...
name: string = "AutoFilter"

Overrides LFOEffect.name

- Defined in [Tone/effect/AutoFilter.ts:29](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/AutoFilter.ts#L29)
...
Inherited from LFOEffect.output
...
Inherited from LFOEffect.version
...
- The minimum value of the filter's cutoff frequency.
  ...
  - Defined in [Tone/effect/AutoFilter.ts:88](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/AutoFilter.ts#L88)

- set baseFrequency(freq): void
...
- #### Parameters
  ...
  - Defined in [Tone/effect/AutoFilter.ts:91](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/AutoFilter.ts#L91)
...
- The number of seconds of 1 processing block (128 samples)
  ...
  Inherited from LFOEffect.blockTime
...
- channelCount is the number of channels used when up-mixing and down-mixing connections to any inputs to the node. The default value is 2 except for specific nodes where its value is specially determined.
  ...
  Inherited from LFOEffect.channelCount
...
- channelCountMode determines how channels will be counted when up-mixing and down-mixing connections to any inputs to the node. The default value is "max". This attribute has no effect for nodes with no inputs.
  ...
  Inherited from LFOEffect.channelCountMode
...
- channelInterpretation determines how individual channels will be treated when up-mixing and down-mixing connections to any inputs to the node. The default value is "speakers".
  ...
  Inherited from LFOEffect.channelInterpretation
...
- Indicates if the instance was disposed. 'Disposing' an instance means that all of the Web Audio nodes that were created for the instance are disconnected and freed for garbage collection.
  ...
  Inherited from LFOEffect.disposed
...
- The number of inputs feeding into the AudioNode. For source nodes, this will be 0.
  ...
  Inherited from LFOEffect.numberOfInputs
...
- The number of outputs of the AudioNode.
  ...
  Inherited from LFOEffect.numberOfOutputs
...
- The maximum value of the filter's cutoff frequency.
  ...
  - Defined in [Tone/effect/AutoFilter.ts:100](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/AutoFilter.ts#L100)

- set octaves(oct): void
...
- #### Parameters
  ...
  - Defined in [Tone/effect/AutoFilter.ts:103](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/AutoFilter.ts#L103)
...
- The duration in seconds of one sample.
  ...
  Inherited from LFOEffect.sampleTime
...
- The type of the LFO's oscillator.
  ...
  Inherited from LFOEffect.type

  - Defined in [Tone/effect/LFOEffect.ts:103](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/LFOEffect.ts#L103)
...
- #### Parameters
  ...
  - Defined in [Tone/effect/LFOEffect.ts:106](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/LFOEffect.ts#L106)
...
- Connect the output of this node to the rest of the nodes in series.
  ...
  Inherited from LFOEffect.chain
...
- connect the output of a ToneAudioNode to an AudioParam, AudioNode, or ToneAudioNode
  ...
  Inherited from LFOEffect.connect
...
- disconnect the output
  ...
  Inherited from LFOEffect.disconnect
...
- #### Returns this
  ...
  Overrides LFOEffect.dispose

  - Defined in [Tone/effect/AutoFilter.ts:108](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/AutoFilter.ts#L108)
...
- get(): [AutoFilterOptions](../interfaces/AutoFilterOptions.md)

- Get the object's attributes.

  #### Returns [AutoFilterOptions](../interfaces/AutoFilterOptions.md)
...
- Return the current time of the Context clock without any lookAhead.
  ...
  Inherited from LFOEffect.immediate
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[AutoFilterOptions](../interfaces/AutoFilterOptions.md)>
...
- Start the effect.
  ...
  Inherited from LFOEffect.start

  - Defined in [Tone/effect/LFOEffect.ts:65](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/LFOEffect.ts#L65)
...
- Stop the lfo
  ...
  Inherited from LFOEffect.stop

  - Defined in [Tone/effect/LFOEffect.ts:73](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/LFOEffect.ts#L73)
...
- Sync the filter to the transport.
  ...
  [LFO.sync](LFO.md#sync)

  Inherited from LFOEffect.sync

  - Defined in [Tone/effect/LFOEffect.ts:82](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/LFOEffect.ts#L82)
...
- Connect the output to the context's destination node.
  ...
  Inherited from LFOEffect.toDestination
...
- Convert the input to a frequency number
  ...
  Inherited from LFOEffect.toFrequency
...
- Connect the output to the context's destination node.
  ...
  [toDestination](AutoFilter.md#toDestination)

  #### Deprecated

  Inherited from LFOEffect.toMaster
...
- Convert the incoming time to seconds. This is calculated against the current TransportClass bpm
  ...
  Inherited from LFOEffect.toSeconds
...
- Convert the class to a string
  ...
  Inherited from LFOEffect.toString
...
- Convert the input time into ticks
  ...
  Inherited from LFOEffect.toTicks
...
- Unsync the filter from the transport.
  ...
  Inherited from LFOEffect.unsync

  - Defined in [Tone/effect/LFOEffect.ts:90](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/LFOEffect.ts#L90)

### `Static` getDefaults

- getDefaults(): [AutoFilterOptions](../interfaces/AutoFilterOptions.md)

- #### Returns [AutoFilterOptions](../interfaces/AutoFilterOptions.md)

  Overrides LFOEffect.getDefaults

  - Defined in [Tone/effect/AutoFilter.ts:73](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/AutoFilter.ts#L73)
