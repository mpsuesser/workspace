<!--
Source: https://wxt.dev/guide/resources/migrate.md
...
  Install `wxt`
  [Extend `.wxt/tsconfig.json`](/guide/essentials/config/typescript#typescript-configuration) in your project's `tsconfig.json`
