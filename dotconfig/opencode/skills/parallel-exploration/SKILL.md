...
isCodebaseModule m = hasDevdocs m        -- internal modules with devdocs package
...
spawn m = do
  context ← case moduleSource m of
    EffectLibrary    → searchEffectDocs m   -- .reporefs/effect-v4/
    CodebaseInternal → devdocs_get_all m    -- domain's devdocs package
...
Your ONLY context: the module's devdocs or Effect reference documentation
