...
* `pagination` - the pagination object that Raycast [`List`s](../../api-reference/user-interface/list.md#props) and [`Grid`s](../../api-reference/user-interface/grid.md#props) expect.
