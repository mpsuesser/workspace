...
* [List](user-interface/list.md) to show multiple similar items, f.e. a list of your open todos.
* [Grid](user-interface/grid.md) similar to a List but with more legroom to show an image for each item, f.e. a collection of icons.
* [Detail](user-interface/detail.md) to present more information, f.e. the details of a GitHub pull request.
* [Form](user-interface/form.md) to create new content, f.e. filing a bug report.

Each component can provide interaction via an [ActionPanel](user-interface/action-panel.md). The panel has a list of [Actions](user-interface/actions.md) where each one can be associated with a [keyboard shortcut](keyboard.md). Shortcuts allow users to use Raycast without using their mouse.
