...
| ----------------------------------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| options\* |             | `{ id: string }` or `{ bounds: { position?: { x?: number; y?: number }; size?: { height?: number; width?: number } }; desktopId?: string }` or `{ bounds: "fullscreen" }` |
...
| ---------------------------------------------------- | ----------- | --------------------------------------------------------------------------------------------------- |
| active\*             |             | `boolean`                                                                                           |
| bounds\*             |             | `{ position: { x: number; y: number }; size: { height: number; width: number } }` or `"fullscreen"` |
| desktopId\*          |             | `string`                                                                                            |
| fullScreenSettable\* |             | `boolean`                                                                                           |
| id\*                 |             | `string`                                                                                            |
| positionable\*       |             | `boolean`                                                                                           |
| resizable\*          |             | `boolean`                                                                                           |
| application                                          |             | [`Application`](utilities.md#application)                                            |
...
| type\*     |             | [`WindowManagement.DesktopType`](#windowmanagement.desktoptype) |
