...
For naming patterns, isolation, and per-stage configuration see [Stages](./stages.md). Credentials per environment are managed via [Profiles](./profiles.md).
...
See [Monorepos](../guides/monorepo.md) for the end-to-end walkthrough (package layout, schema sharing, deploy ordering).
