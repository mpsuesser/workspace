...
- Effect<[VibratoOptions](../interfaces/VibratoOptions.md)>
  - Vibrato

- Defined in [Tone/effect/Vibrato.ts:22](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Vibrato.ts#L22)

## Constructors

### constructor

- new Vibrato(frequency?, depth?): [Vibrato](Vibrato.md)
...
- #### Parameters
  ...
  #### Returns [Vibrato](Vibrato.md)

  Overrides Effect<VibratoOptions>.constructor

  - Defined in [Tone/effect/Vibrato.ts:48](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Vibrato.ts#L48)

- new Vibrato(options?): [Vibrato](Vibrato.md)

- #### Parameters

  - `Optional` options: Partial<[VibratoOptions](../interfaces/VibratoOptions.md)>

  #### Returns [Vibrato](Vibrato.md)

  Overrides Effect<VibratoOptions>.constructor

  - Defined in [Tone/effect/Vibrato.ts:49](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Vibrato.ts#L49)
...
- Defined in [Tone/effect/Vibrato.ts:42](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Vibrato.ts#L42)
...
- Defined in [Tone/effect/Vibrato.ts:37](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Vibrato.ts#L37)
...
- Defined in [Tone/effect/Vibrato.ts:23](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Vibrato.ts#L23)
...
- Type of oscillator attached to the Vibrato.
  ...
  - Defined in [Tone/effect/Vibrato.ts:92](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Vibrato.ts#L92)
...
- #### Parameters
  ...
  - Defined in [Tone/effect/Vibrato.ts:95](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Vibrato.ts#L95)
...
- #### Returns this
  ...
  - Defined in [Tone/effect/Vibrato.ts:99](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Vibrato.ts#L99)
...
- get(): [VibratoOptions](../interfaces/VibratoOptions.md)

- Get the object's attributes.

  #### Returns [VibratoOptions](../interfaces/VibratoOptions.md)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[VibratoOptions](../interfaces/VibratoOptions.md)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](Vibrato.md#toDestination)
...
- getDefaults(): [VibratoOptions](../interfaces/VibratoOptions.md)

- #### Returns [VibratoOptions](../interfaces/VibratoOptions.md)

  Overrides Effect.getDefaults

  - Defined in [Tone/effect/Vibrato.ts:80](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Vibrato.ts#L80)
