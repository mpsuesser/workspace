...
#### Hierarchy ([view full](../hierarchy.md#Multiply))

- [Signal](Signal.md)<[TypeName](Multiply.md#constructor.new_Multiply.TypeName-1)>
  - Multiply

- Defined in [Tone/signal/Multiply.ts:26](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/Multiply.ts#L26)

## Constructors

### constructor

- new Multiply<[TypeName](Multiply.md#constructor.new_Multiply.TypeName-1)>(value?): [Multiply](Multiply.md)<[TypeName](Multiply.md#constructor.new_Multiply.TypeName-1)>
...
- #### Type Parameters
  ...
  #### Returns [Multiply](Multiply.md)<[TypeName](Multiply.md#constructor.new_Multiply.TypeName-1)>

  Overrides [Signal](Signal.md).[constructor](Signal.md#constructor)

  - Defined in [Tone/signal/Multiply.ts:59](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/Multiply.ts#L59)

- new Multiply<[TypeName](Multiply.md#constructor.new_Multiply-1.TypeName-2)>(options?): [Multiply](Multiply.md)<[TypeName](Multiply.md#constructor.new_Multiply.TypeName-1)>
...
- #### Type Parameters
  ...
  - `Optional` options: Partial<[SignalOptions](../interfaces/SignalOptions.md)<[TypeName](Multiply.md#constructor.new_Multiply.TypeName-1)>>

  #### Returns [Multiply](Multiply.md)<[TypeName](Multiply.md#constructor.new_Multiply.TypeName-1)>

  Overrides [Signal](Signal.md).[constructor](Signal.md#constructor)

  - Defined in [Tone/signal/Multiply.ts:60](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/Multiply.ts#L60)
...
factor: [Param](Param.md)<[TypeName](Multiply.md#constructor.new_Multiply.TypeName-1)>

The multiplication factor. Can be set directly or a signal can be connected to it.

- Defined in [Tone/signal/Multiply.ts:54](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/Multiply.ts#L54)
...
- Defined in [Tone/signal/Multiply.ts:44](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/Multiply.ts#L44)
...
- Defined in [Tone/signal/Multiply.ts:29](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/Multiply.ts#L29)

### output

output: [OutputNode](../types/OutputNode.md)

The product of the input and [factor](Multiply.md#factor)

Overrides [Signal](Signal.md).[output](Signal.md#output)

- Defined in [Tone/signal/Multiply.ts:49](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/Multiply.ts#L49)
...
- Defined in [Tone/signal/Multiply.ts:34](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/Multiply.ts#L34)
...
- Dispose and disconnect
  ...
  - Defined in [Tone/signal/Multiply.ts:89](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/Multiply.ts#L89)
...
- #### Parameters
  ...
  - value: [UnitMap](../interfaces/Unit.UnitMap.md)\[[TypeName](Multiply.md#constructor.new_Multiply.TypeName-1)\]
  - time: [Unit](../modules/Unit.md).[Time](../types/Unit.Time.md)
...
- getValueAtTime(time): [UnitMap](../interfaces/Unit.UnitMap.md)\[[TypeName](Multiply.md#constructor.new_Multiply.TypeName-1)\]

- #### Parameters

  - time: [Unit](../modules/Unit.md).[Time](../types/Unit.Time.md)

  #### Returns [UnitMap](../interfaces/Unit.UnitMap.md)\[[TypeName](Multiply.md#constructor.new_Multiply.TypeName-1)\]
...
- #### Parameters
  ...
  - values: [UnitMap](../interfaces/Unit.UnitMap.md)\[[TypeName](Multiply.md#constructor.new_Multiply.TypeName-1)\]\[\]
  - startTime: [Unit](../modules/Unit.md).[Time](../types/Unit.Time.md)
...
- Connect the output to the context's destination node.
  ...
  [toDestination](Multiply.md#toDestination)
...
- #### Returns [SignalOptions](../interfaces/SignalOptions.md)<any>
  ...
  - Defined in [Tone/signal/Multiply.ts:83](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/Multiply.ts#L83)
