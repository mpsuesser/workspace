...
- SignalOperator<WaveShaperOptions>
  - WaveShaper

- Defined in [Tone/signal/WaveShaper.ts:29](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/WaveShaper.ts#L29)

## Constructors

### constructor

- new WaveShaper(mapping?, length?): [WaveShaper](WaveShaper.md)

- #### Parameters

  - `Optional` mapping: WaveShaperMapping
  ...
  #### Returns [WaveShaper](WaveShaper.md)

  Overrides SignalOperator<WaveShaperOptions>.constructor

  - Defined in [Tone/signal/WaveShaper.ts:59](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/WaveShaper.ts#L59)

- new WaveShaper(options?): [WaveShaper](WaveShaper.md)

- #### Parameters

  - `Optional` options: Partial<WaveShaperOptions>

  #### Returns [WaveShaper](WaveShaper.md)

  Overrides SignalOperator<WaveShaperOptions>.constructor

  - Defined in [Tone/signal/WaveShaper.ts:60](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/WaveShaper.ts#L60)
...
Inherited from SignalOperator.context
...
Inherited from SignalOperator.debug
...
Overrides SignalOperator.input

- Defined in [Tone/signal/WaveShaper.ts:40](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/WaveShaper.ts#L40)

### `Readonly` name

name: string = "WaveShaper"

Overrides SignalOperator.name

- Defined in [Tone/signal/WaveShaper.ts:30](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/WaveShaper.ts#L30)
...
Overrides SignalOperator.output

- Defined in [Tone/signal/WaveShaper.ts:45](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/WaveShaper.ts#L45)
...
Inherited from SignalOperator.version
...
- The number of seconds of 1 processing block (128 samples)
  ...
  Inherited from SignalOperator.blockTime
...
- channelCount is the number of channels used when up-mixing and down-mixing connections to any inputs to the node. The default value is 2 except for specific nodes where its value is specially determined.
  ...
  Inherited from SignalOperator.channelCount
...
- channelCountMode determines how channels will be counted when up-mixing and down-mixing connections to any inputs to the node. The default value is "max". This attribute has no effect for nodes with no inputs.
  ...
  Inherited from SignalOperator.channelCountMode
...
- channelInterpretation determines how individual channels will be treated when up-mixing and down-mixing connections to any inputs to the node. The default value is "speakers".
  ...
  Inherited from SignalOperator.channelInterpretation
...
- The array to set as the waveshaper curve. For linear curves array length does not make much difference, but for complex curves longer arrays will provide smoother interpolation.
  ...
  - Defined in [Tone/signal/WaveShaper.ts:112](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/WaveShaper.ts#L112)

- set curve(mapping): void

- #### Parameters

  - mapping: null \| Float32Array

  #### Returns void

  - Defined in [Tone/signal/WaveShaper.ts:116](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/WaveShaper.ts#L116)
...
- Indicates if the instance was disposed. 'Disposing' an instance means that all of the Web Audio nodes that were created for the instance are disconnected and freed for garbage collection.
  ...
  Inherited from SignalOperator.disposed
...
- The number of inputs feeding into the AudioNode. For source nodes, this will be 0.
  ...
  Inherited from SignalOperator.numberOfInputs
...
- The number of outputs of the AudioNode.
  ...
  Inherited from SignalOperator.numberOfOutputs
...
- Specifies what type of oversampling (if any) should be used when applying the shaping curve. Can either be "none", "2x" or "4x".
  ...
  - Defined in [Tone/signal/WaveShaper.ts:124](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/WaveShaper.ts#L124)

- set oversample(oversampling): void

- #### Parameters

  - oversampling: OverSampleType

  #### Returns void

  - Defined in [Tone/signal/WaveShaper.ts:128](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/WaveShaper.ts#L128)
...
- The duration in seconds of one sample.
  ...
  Inherited from SignalOperator.sampleTime
...
- Connect the output of this node to the rest of the nodes in series.
  ...
  Inherited from SignalOperator.chain
...
- #### Parameters
  ...
  Inherited from SignalOperator.connect
...
- disconnect the output
  ...
  Inherited from SignalOperator.disconnect
...
- Clean up.
  ...
  Overrides SignalOperator.dispose

  - Defined in [Tone/signal/WaveShaper.ts:142](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/WaveShaper.ts#L142)
...
- connect the output of this node to the rest of the nodes in parallel.
  ...
  Inherited from SignalOperator.fan
...
- Get the object's attributes.
  ...
  Inherited from SignalOperator.get
...
- Return the current time of the Context clock without any lookAhead.
  ...
  Inherited from SignalOperator.immediate
...
- Return the current time of the Context clock plus the lookAhead.
  ...
  Inherited from SignalOperator.now
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<WaveShaperOptions>
  ...
  Inherited from SignalOperator.set
...
- setMap(mapping, length?): this

- Uses a mapping function to set the value of the curve.

  #### Parameters

  - mapping: [WaveShaperMappingFn](../types/WaveShaperMappingFn.md)
  ...
  - Defined in [Tone/signal/WaveShaper.ts:97](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/WaveShaper.ts#L97)
...
- Connect the output to the context's destination node.
  ...
  Inherited from SignalOperator.toDestination
...
- Convert the input to a frequency number
  ...
  Inherited from SignalOperator.toFrequency
...
- Connect the output to the context's destination node.
  ...
  [toDestination](WaveShaper.md#toDestination)

  #### Deprecated

  Inherited from SignalOperator.toMaster
...
- Convert the incoming time to seconds. This is calculated against the current TransportClass bpm
  ...
  Inherited from SignalOperator.toSeconds
...
- Convert the class to a string
  ...
  Inherited from SignalOperator.toString
...
- Convert the input time into ticks
  ...
  Inherited from SignalOperator.toTicks
...
- #### Returns WaveShaperOptions
  ...
  Overrides SignalOperator.getDefaults

  - Defined in [Tone/signal/WaveShaper.ts:79](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/WaveShaper.ts#L79)
