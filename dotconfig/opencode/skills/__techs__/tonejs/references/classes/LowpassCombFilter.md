...
A lowpass feedback comb filter. It is similar to [FeedbackCombFilter](FeedbackCombFilter.md), but includes a lowpass filter.

#### Hierarchy ([view full](../hierarchy.md#LowpassCombFilter))

- [ToneAudioNode](ToneAudioNode.md)<LowpassCombFilterOptions>
  - LowpassCombFilter

- Defined in [Tone/component/filter/LowpassCombFilter.ts:25](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/LowpassCombFilter.ts#L25)

## Constructors

### constructor

- new LowpassCombFilter(delayTime?, resonance?, dampening?): [LowpassCombFilter](LowpassCombFilter.md)
...
- #### Parameters
  ...
  #### Returns [LowpassCombFilter](LowpassCombFilter.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/component/filter/LowpassCombFilter.ts:56](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/LowpassCombFilter.ts#L56)

- new LowpassCombFilter(options?): [LowpassCombFilter](LowpassCombFilter.md)

- #### Parameters

  - `Optional` options: RecursivePartial<LowpassCombFilterOptions>

  #### Returns [LowpassCombFilter](LowpassCombFilter.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/component/filter/LowpassCombFilter.ts:61](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/LowpassCombFilter.ts#L61)
...
- Defined in [Tone/component/filter/LowpassCombFilter.ts:41](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/LowpassCombFilter.ts#L41)
...
- Defined in [Tone/component/filter/LowpassCombFilter.ts:48](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/LowpassCombFilter.ts#L48)

### `Readonly` name

name: "LowpassCombFilter" = "LowpassCombFilter"

The name of the class

Overrides [ToneAudioNode](ToneAudioNode.md).[name](ToneAudioNode.md#name)

- Defined in [Tone/component/filter/LowpassCombFilter.ts:26](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/LowpassCombFilter.ts#L26)
...
- Defined in [Tone/component/filter/LowpassCombFilter.ts:49](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/LowpassCombFilter.ts#L49)
...
- Defined in [Tone/component/filter/LowpassCombFilter.ts:46](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/LowpassCombFilter.ts#L46)
...
- The dampening control of the feedback
  ...
  - Defined in [Tone/component/filter/LowpassCombFilter.ts:99](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/LowpassCombFilter.ts#L99)
...
- #### Parameters
  ...
  - Defined in [Tone/component/filter/LowpassCombFilter.ts:102](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/LowpassCombFilter.ts#L102)
...
- Dispose and disconnect
  ...
  - Defined in [Tone/component/filter/LowpassCombFilter.ts:106](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/LowpassCombFilter.ts#L106)
...
- get(): LowpassCombFilterOptions

- Get the object's attributes.

  #### Returns LowpassCombFilterOptions
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<LowpassCombFilterOptions>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](LowpassCombFilter.md#toDestination)
...
- getDefaults(): LowpassCombFilterOptions

- #### Returns LowpassCombFilterOptions

  Overrides [ToneAudioNode](ToneAudioNode.md).[getDefaults](ToneAudioNode.md#getDefaults)

  - Defined in [Tone/component/filter/LowpassCombFilter.ts:88](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/LowpassCombFilter.ts#L88)
