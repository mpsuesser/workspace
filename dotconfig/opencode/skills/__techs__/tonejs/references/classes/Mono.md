...
Mono coerces the incoming mono or stereo signal into a mono signal where both left and right channels have the same value. This can be useful for [stereo imaging](https://en.wikipedia.org/wiki/Stereo_imaging).

#### Hierarchy ([view full](../hierarchy.md#Mono))

- [ToneAudioNode](ToneAudioNode.md)<[MonoOptions](../types/MonoOptions.md)>
  - Mono

- Defined in [Tone/component/channel/Mono.ts:18](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Mono.ts#L18)

## Constructors

### constructor

- new Mono(options?): [Mono](Mono.md)

- #### Parameters

  - `Optional` options: Partial<ToneWithContextOptions>

  #### Returns [Mono](Mono.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/component/channel/Mono.ts:36](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Mono.ts#L36)
...
- Defined in [Tone/component/channel/Mono.ts:34](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Mono.ts#L34)
...
- Defined in [Tone/component/channel/Mono.ts:19](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Mono.ts#L19)
...
- Defined in [Tone/component/channel/Mono.ts:29](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Mono.ts#L29)
...
- Dispose and disconnect
  ...
  - Defined in [Tone/component/channel/Mono.ts:51](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Mono.ts#L51)
...
- Connect the output to the context's destination node.
  ...
  [toDestination](Mono.md#toDestination)
