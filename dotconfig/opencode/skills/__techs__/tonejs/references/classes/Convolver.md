...
#### Hierarchy ([view full](../hierarchy.md#Convolver))

- [ToneAudioNode](ToneAudioNode.md)<[ConvolverOptions](../interfaces/ConvolverOptions.md)>
  - Convolver

- Defined in [Tone/component/filter/Convolver.ts:27](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/Convolver.ts#L27)

## Constructors

### constructor

- new Convolver(url?, onload?): [Convolver](Convolver.md)
...
- #### Parameters
  ...
  #### Returns [Convolver](Convolver.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/component/filter/Convolver.ts:47](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/Convolver.ts#L47)

- new Convolver(options?): [Convolver](Convolver.md)

- #### Parameters

  - `Optional` options: Partial<[ConvolverOptions](../interfaces/ConvolverOptions.md)>

  #### Returns [Convolver](Convolver.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/component/filter/Convolver.ts:51](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/Convolver.ts#L51)
...
- Defined in [Tone/component/filter/Convolver.ts:40](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/Convolver.ts#L40)

### `Readonly` name

name: string = "Convolver"

The name of the class

Overrides [ToneAudioNode](ToneAudioNode.md).[name](ToneAudioNode.md#name)

- Defined in [Tone/component/filter/Convolver.ts:28](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/Convolver.ts#L28)
...
- Defined in [Tone/component/filter/Convolver.ts:41](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/Convolver.ts#L41)
...
- get buffer(): null \| [ToneAudioBuffer](ToneAudioBuffer.md)

- The convolver's buffer

  #### Returns null \| [ToneAudioBuffer](ToneAudioBuffer.md)

  - Defined in [Tone/component/filter/Convolver.ts:100](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/Convolver.ts#L100)

- set buffer(buffer): void

- #### Parameters

  - buffer: null \| [ToneAudioBuffer](ToneAudioBuffer.md)

  #### Returns void

  - Defined in [Tone/component/filter/Convolver.ts:107](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/Convolver.ts#L107)
...
- The normalize property of the ConvolverNode interface is a boolean that controls whether the impulse response from the buffer will be scaled by an equal-power normalization when the buffer attribute is set, or not.
  ...
  - Defined in [Tone/component/filter/Convolver.ts:129](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/Convolver.ts#L129)

- set normalize(norm): void
...
- #### Parameters
  ...
  - Defined in [Tone/component/filter/Convolver.ts:132](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/Convolver.ts#L132)
...
- Dispose and disconnect
  ...
  - Defined in [Tone/component/filter/Convolver.ts:136](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/Convolver.ts#L136)
...
- get(): [ConvolverOptions](../interfaces/ConvolverOptions.md)

- Get the object's attributes.

  #### Returns [ConvolverOptions](../interfaces/ConvolverOptions.md)
...
- Load an impulse response url as an audio buffer. Decodes the audio asynchronously and invokes the callback once the audio buffer loads.
  ...
  - Defined in [Tone/component/filter/Convolver.ts:93](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/Convolver.ts#L93)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[ConvolverOptions](../interfaces/ConvolverOptions.md)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](Convolver.md#toDestination)
...
- getDefaults(): [ConvolverOptions](../interfaces/ConvolverOptions.md)

- #### Returns [ConvolverOptions](../interfaces/ConvolverOptions.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[getDefaults](ToneAudioNode.md#getDefaults)

  - Defined in [Tone/component/filter/Convolver.ts:80](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/filter/Convolver.ts#L80)
