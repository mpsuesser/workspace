...
MidSideMerge merges the mid and side signal after they've been separated by [MidSideSplit](MidSideSplit.md)

    Mid = (Left+Right)/sqrt(2);   // obtain mid-signal from left and right
    Side = (Left-Right)/sqrt(2);   // obtain side-signal from left and right

#### Hierarchy ([view full](../hierarchy.md#MidSideMerge))

- [ToneAudioNode](ToneAudioNode.md)<[MidSideMergeOptions](../types/MidSideMergeOptions.md)>
  - MidSideMerge

- Defined in [Tone/component/channel/MidSideMerge.ts:22](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/MidSideMerge.ts#L22)

## Constructors

### constructor

- new MidSideMerge(options?): [MidSideMerge](MidSideMerge.md)

- #### Parameters

  - `Optional` options: Partial<ToneWithContextOptions>

  #### Returns [MidSideMerge](MidSideMerge.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/component/channel/MidSideMerge.ts:70](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/MidSideMerge.ts#L70)
...
There is no input, connect sources to either [mid](MidSideMerge.md#mid) or [side](MidSideMerge.md#side) inputs.

Overrides [ToneAudioNode](ToneAudioNode.md).[input](ToneAudioNode.md#input)

- Defined in [Tone/component/channel/MidSideMerge.ts:28](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/MidSideMerge.ts#L28)

### `Readonly` mid

mid: [ToneAudioNode](ToneAudioNode.md)<ToneWithContextOptions>

The "mid" input.

- Defined in [Tone/component/channel/MidSideMerge.ts:43](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/MidSideMerge.ts#L43)

### `Readonly` name

name: string = "MidSideMerge"

The name of the class

Overrides [ToneAudioNode](ToneAudioNode.md).[name](ToneAudioNode.md#name)

- Defined in [Tone/component/channel/MidSideMerge.ts:23](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/MidSideMerge.ts#L23)

### `Readonly` output

output: [Merge](Merge.md)

The merged signal

Overrides [ToneAudioNode](ToneAudioNode.md).[output](ToneAudioNode.md#output)

- Defined in [Tone/component/channel/MidSideMerge.ts:33](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/MidSideMerge.ts#L33)

### `Readonly` side

side: [ToneAudioNode](ToneAudioNode.md)<ToneWithContextOptions>

The "side" input.

- Defined in [Tone/component/channel/MidSideMerge.ts:48](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/MidSideMerge.ts#L48)
...
- Dispose and disconnect
  ...
  - Defined in [Tone/component/channel/MidSideMerge.ts:97](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/MidSideMerge.ts#L97)
...
- Connect the output to the context's destination node.
  ...
  [toDestination](MidSideMerge.md#toDestination)
...
- #### Returns ToneWithContextOptions
  ...
  Inherited from [ToneAudioNode](ToneAudioNode.md).[getDefaults](ToneAudioNode.md#getDefaults)
