...
- Effect<[FrequencyShifterOptions](../interfaces/FrequencyShifterOptions.md)>
  - FrequencyShifter

- Defined in [Tone/effect/FrequencyShifter.ts:34](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/FrequencyShifter.ts#L34)

## Constructors

### constructor

- new FrequencyShifter(frequency?): [FrequencyShifter](FrequencyShifter.md)
...
- #### Parameters
  ...
  #### Returns [FrequencyShifter](FrequencyShifter.md)

  Overrides Effect<FrequencyShifterOptions>.constructor

  - Defined in [Tone/effect/FrequencyShifter.ts:81](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/FrequencyShifter.ts#L81)

- new FrequencyShifter(options?): [FrequencyShifter](FrequencyShifter.md)

- #### Parameters

  - `Optional` options: Partial<[FrequencyShifterOptions](../interfaces/FrequencyShifterOptions.md)>

  #### Returns [FrequencyShifter](FrequencyShifter.md)

  Overrides Effect<FrequencyShifterOptions>.constructor

  - Defined in [Tone/effect/FrequencyShifter.ts:82](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/FrequencyShifter.ts#L82)
...
- Defined in [Tone/effect/FrequencyShifter.ts:41](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/FrequencyShifter.ts#L41)
...
name: string = "FrequencyShifter"

Overrides Effect.name

- Defined in [Tone/effect/FrequencyShifter.ts:35](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/FrequencyShifter.ts#L35)
...
- #### Returns this
  ...
  - Defined in [Tone/effect/FrequencyShifter.ts:145](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/FrequencyShifter.ts#L145)
...
- get(): [FrequencyShifterOptions](../interfaces/FrequencyShifterOptions.md)

- Get the object's attributes.

  #### Returns [FrequencyShifterOptions](../interfaces/FrequencyShifterOptions.md)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[FrequencyShifterOptions](../interfaces/FrequencyShifterOptions.md)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](FrequencyShifter.md#toDestination)
...
- getDefaults(): [FrequencyShifterOptions](../interfaces/FrequencyShifterOptions.md)

- #### Returns [FrequencyShifterOptions](../interfaces/FrequencyShifterOptions.md)

  Overrides Effect.getDefaults

  - Defined in [Tone/effect/FrequencyShifter.ts:139](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/FrequencyShifter.ts#L139)
