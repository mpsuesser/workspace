...
- Options extends [ScaleOptions](../interfaces/ScaleOptions.md) = [ScaleOptions](../interfaces/ScaleOptions.md)

#### Hierarchy ([view full](../hierarchy.md#Scale))

- SignalOperator<[Options](Scale.md#constructor.new_Scale.Options-1)>
  - Scale
    - [ScaleExp](ScaleExp.md)

- Defined in [Tone/signal/Scale.ts:27](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/Scale.ts#L27)

## Constructors

### constructor

- new Scale<[Options](Scale.md#constructor.new_Scale.Options-1)>(min?, max?): [Scale](Scale.md)<[Options](Scale.md#constructor.new_Scale.Options-1)>
...
- #### Type Parameters
  ...
  #### Returns [Scale](Scale.md)<[Options](Scale.md#constructor.new_Scale.Options-1)>

  Overrides SignalOperator<Options>.constructor

  - Defined in [Tone/signal/Scale.ts:59](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/Scale.ts#L59)

- new Scale<[Options](Scale.md#constructor.new_Scale-1.Options-2)>(options?): [Scale](Scale.md)<[Options](Scale.md#constructor.new_Scale.Options-1)>
...
- #### Type Parameters
  ...
  - `Optional` options: Partial<[ScaleOptions](../interfaces/ScaleOptions.md)>

  #### Returns [Scale](Scale.md)<[Options](Scale.md#constructor.new_Scale.Options-1)>

  Overrides SignalOperator<Options>.constructor

  - Defined in [Tone/signal/Scale.ts:60](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/Scale.ts#L60)
...
- Defined in [Tone/signal/Scale.ts:30](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/Scale.ts#L30)
...
- #### Returns this
  ...
  - Defined in [Tone/signal/Scale.ts:121](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/Scale.ts#L121)
...
- get(): [Options](Scale.md#constructor.new_Scale.Options-1)

- Get the object's attributes.

  #### Returns [Options](Scale.md#constructor.new_Scale.Options-1)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[Options](Scale.md#constructor.new_Scale.Options-1)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](Scale.md#toDestination)
...
- getDefaults(): [ScaleOptions](../interfaces/ScaleOptions.md)

- #### Returns [ScaleOptions](../interfaces/ScaleOptions.md)

  Overrides SignalOperator.getDefaults

  - Defined in [Tone/signal/Scale.ts:84](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/Scale.ts#L84)
