...
- Effect<[BitCrusherOptions](../interfaces/BitCrusherOptions.md)>
  - BitCrusher

- Defined in [Tone/effect/BitCrusher.ts:29](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/BitCrusher.ts#L29)

## Constructors

### constructor

- new BitCrusher(bits?): [BitCrusher](BitCrusher.md)

- #### Parameters

  - `Optional` bits: number

  #### Returns [BitCrusher](BitCrusher.md)

  Overrides Effect<BitCrusherOptions>.constructor

  - Defined in [Tone/effect/BitCrusher.ts:44](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/BitCrusher.ts#L44)

- new BitCrusher(options?): [BitCrusher](BitCrusher.md)

- #### Parameters

  - `Optional` options: Partial<BitCrusherWorkletOptions>

  #### Returns [BitCrusher](BitCrusher.md)

  Overrides Effect<BitCrusherOptions>.constructor

  - Defined in [Tone/effect/BitCrusher.ts:45](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/BitCrusher.ts#L45)

## Properties

### `Readonly` bits

bits: [Param](Param.md)<"positive">
...
- Defined in [Tone/effect/BitCrusher.ts:37](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/BitCrusher.ts#L37)
...
name: string = "BitCrusher"

Overrides Effect.name

- Defined in [Tone/effect/BitCrusher.ts:30](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/BitCrusher.ts#L30)
...
- #### Returns this
  ...
  - Defined in [Tone/effect/BitCrusher.ts:70](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/BitCrusher.ts#L70)
...
- get(): [BitCrusherOptions](../interfaces/BitCrusherOptions.md)

- Get the object's attributes.

  #### Returns [BitCrusherOptions](../interfaces/BitCrusherOptions.md)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[BitCrusherOptions](../interfaces/BitCrusherOptions.md)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](BitCrusher.md#toDestination)
...
- getDefaults(): [BitCrusherOptions](../interfaces/BitCrusherOptions.md)

- #### Returns [BitCrusherOptions](../interfaces/BitCrusherOptions.md)

  Overrides Effect.getDefaults

  - Defined in [Tone/effect/BitCrusher.ts:64](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/BitCrusher.ts#L64)
