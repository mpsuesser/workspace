...
#### Hierarchy ([view full](../hierarchy.md#UserMedia))

- [ToneAudioNode](ToneAudioNode.md)<[UserMediaOptions](../interfaces/UserMediaOptions.md)>
  - UserMedia

- Defined in [Tone/source/UserMedia.ts:39](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/UserMedia.ts#L39)

## Constructors

### constructor

- new UserMedia(volume?): [UserMedia](UserMedia.md)
...
- #### Parameters
  ...
  #### Returns [UserMedia](UserMedia.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/source/UserMedia.ts:73](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/UserMedia.ts#L73)

- new UserMedia(options?): [UserMedia](UserMedia.md)

- #### Parameters

  - `Optional` options: Partial<[UserMediaOptions](../interfaces/UserMediaOptions.md)>

  #### Returns [UserMedia](UserMedia.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/source/UserMedia.ts:74](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/UserMedia.ts#L74)
...
- Defined in [Tone/source/UserMedia.ts:42](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/UserMedia.ts#L42)
...
- Defined in [Tone/source/UserMedia.ts:40](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/UserMedia.ts#L40)
...
- Defined in [Tone/source/UserMedia.ts:43](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/UserMedia.ts#L43)
...
- Defined in [Tone/source/UserMedia.ts:68](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/UserMedia.ts#L68)
...
- Returns an identifier for the represented device that is persisted across sessions. It is un-guessable by other applications and unique to the origin of the calling application. It is reset when the user clears cookies (for Private Browsing, a different identifier is used that is not persisted across sessions). Returns undefined when the device is not open.
  ...
  - Defined in [Tone/source/UserMedia.ts:204](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/UserMedia.ts#L204)
...
- Returns a group identifier. Two devices have the same group identifier if they belong to the same physical device. Returns null when the device is not open.
  ...
  - Defined in [Tone/source/UserMedia.ts:217](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/UserMedia.ts#L217)
...
- Returns a label describing this device (for example "Built-in Microphone"). Returns undefined when the device is not open or label is not available because of permissions.
  ...
  - Defined in [Tone/source/UserMedia.ts:230](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/UserMedia.ts#L230)
...
- Mute the output.
  ...
  - Defined in [Tone/source/UserMedia.ts:248](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/UserMedia.ts#L248)
...
- #### Parameters
  ...
  - Defined in [Tone/source/UserMedia.ts:251](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/UserMedia.ts#L251)
...
- Returns the playback state of the source, "started" when the microphone is open and "stopped" when the mic is closed.
  ...
  - Defined in [Tone/source/UserMedia.ts:192](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/UserMedia.ts#L192)
...
- If getUserMedia is supported by the browser.
  ...
  - Defined in [Tone/source/UserMedia.ts:266](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/UserMedia.ts#L266)
...
- Close the media stream
  ...
  - Defined in [Tone/source/UserMedia.ts:158](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/UserMedia.ts#L158)
...
- Dispose and disconnect
  ...
  - Defined in [Tone/source/UserMedia.ts:255](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/UserMedia.ts#L255)
...
- get(): [UserMediaOptions](../interfaces/UserMediaOptions.md)

- Get the object's attributes.

  #### Returns [UserMediaOptions](../interfaces/UserMediaOptions.md)
...
- open(labelOrId?): Promise<[UserMedia](UserMedia.md)>
...
- Open the media stream. If a string is passed in, it is assumed to be the label or id of the stream, if a number is passed in, it is the input number of the stream.
  ...
  #### Returns Promise<[UserMedia](UserMedia.md)>

  The promise is resolved when the stream is open.

  - Defined in [Tone/source/UserMedia.ts:107](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/UserMedia.ts#L107)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[UserMediaOptions](../interfaces/UserMediaOptions.md)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](UserMedia.md#toDestination)
...
- Returns a promise which resolves with the list of audio input devices available.
  ...
  - Defined in [Tone/source/UserMedia.ts:181](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/UserMedia.ts#L181)

### `Static` getDefaults

- getDefaults(): [UserMediaOptions](../interfaces/UserMediaOptions.md)

- #### Returns [UserMediaOptions](../interfaces/UserMediaOptions.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[getDefaults](ToneAudioNode.md#getDefaults)

  - Defined in [Tone/source/UserMedia.ts:92](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/source/UserMedia.ts#L92)
