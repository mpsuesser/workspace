...
Tone.NoiseSynth is composed of [Noise](Noise.md) through an [AmplitudeEnvelope](AmplitudeEnvelope.md).
...
- Instrument<[NoiseSynthOptions](../interfaces/NoiseSynthOptions.md)>
  - NoiseSynth

- Defined in [Tone/instrument/NoiseSynth.ts:31](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/NoiseSynth.ts#L31)

## Constructors

### constructor

- new NoiseSynth(options?): [NoiseSynth](NoiseSynth.md)

- #### Parameters

  - `Optional` options: RecursivePartial<[NoiseSynthOptions](../interfaces/NoiseSynthOptions.md)>

  #### Returns [NoiseSynth](NoiseSynth.md)

  Overrides Instrument<NoiseSynthOptions>.constructor

  - Defined in [Tone/instrument/NoiseSynth.ts:44](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/NoiseSynth.ts#L44)
...
- Defined in [Tone/instrument/NoiseSynth.ts:42](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/NoiseSynth.ts#L42)
...
name: "NoiseSynth" = "NoiseSynth"

Overrides Instrument.name

- Defined in [Tone/instrument/NoiseSynth.ts:32](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/NoiseSynth.ts#L32)
...
- Defined in [Tone/instrument/NoiseSynth.ts:37](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/NoiseSynth.ts#L37)
...
- #### Returns this
  ...
  - Defined in [Tone/instrument/NoiseSynth.ts:161](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/NoiseSynth.ts#L161)
...
- get(): [NoiseSynthOptions](../interfaces/NoiseSynthOptions.md)

- Get the object's attributes.

  #### Returns [NoiseSynthOptions](../interfaces/NoiseSynthOptions.md)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[NoiseSynthOptions](../interfaces/NoiseSynthOptions.md)>
...
- #### Returns this
  ...
  - Defined in [Tone/instrument/NoiseSynth.ts:131](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/NoiseSynth.ts#L131)
...
- Connect the output to the context's destination node.
  ...
  [toDestination](NoiseSynth.md#toDestination)
...
- Start the attack portion of the envelopes. Unlike other instruments, Tone.NoiseSynth doesn't have a note.
  ...
  - Defined in [Tone/instrument/NoiseSynth.ts:105](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/NoiseSynth.ts#L105)
...
- Trigger the attack and then the release after the duration.
  ...
  - Defined in [Tone/instrument/NoiseSynth.ts:149](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/NoiseSynth.ts#L149)
...
- Start the release portion of the envelopes.
  ...
  - Defined in [Tone/instrument/NoiseSynth.ts:124](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/NoiseSynth.ts#L124)
...
- getDefaults(): [NoiseSynthOptions](../interfaces/NoiseSynthOptions.md)

- #### Returns [NoiseSynthOptions](../interfaces/NoiseSynthOptions.md)

  Overrides Instrument.getDefaults

  - Defined in [Tone/instrument/NoiseSynth.ts:74](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/NoiseSynth.ts#L74)
