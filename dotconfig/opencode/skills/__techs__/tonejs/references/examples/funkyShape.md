...
Access the envelopes current value to synchronize visuals. This sketch uses [p5.js](https://p5js.org) for canvas rendering.\
\
Example by [polyrhythmatic](https://github.com/polyrhythmatic)
...
Source: [funkyShape.html](https://github.com/Tonejs/Tone.js/blob/main/examples/funkyShape.html)
