...
See [Quickstart](./quickstart.md) to install Oxlint.
...
You also need to ensure `oxlint-tsgolint` is installed in your project. See [the type-aware linting docs](./type-aware.md) for more details.
