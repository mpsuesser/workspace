...
export class AnalyticsService extends ServiceMap.Service<AnalyticsService, { track: (event: string) => Effect.Effect<void> }>()(
  "AnalyticsService"
) {}
```
...
declare var ConsentListVM: ServiceMap.Service<ConsentListVM, ConsentListVM>
interface ConsentListVM {}

// services/ConsentService.ts - shared business logic
export class ConsentService extends ServiceMap.Service<ConsentService, { getConsents: Effect.Effect<Consent[]> }>()(
  "ConsentService"
) {}
...
// 2. Tag
export const WalletVM = ServiceMap.Service<WalletVM>("WalletVM")
...
```tsx
class ConsentService extends ServiceMap.Service<ConsentService>()("ConsentService", {
...
export const useVM = <Id, Value, E>(
  tag: ServiceMap.Service<Id, Value>,
  layer: Layer.Layer<Id, E, Scope.Scope | AtomRegistry>
): AsyncResult.AsyncResult<Value, E> => useAtomValue(vmAtom(makeVmKey(tag, layer)))
```
