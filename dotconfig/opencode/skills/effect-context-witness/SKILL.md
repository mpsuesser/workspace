...
description: Decide between ServiceMap.Service witness and capability patterns for dependency injection, understanding coupling trade-offs
---

# Context Witness Pattern

Choose between witness (existence) and capability (behavior) patterns for ServiceMap.Service definitions.
...
class Serial extends ServiceMap.Service<Serial, string>()("Serial") {}
...
export class Serial extends ServiceMap.Service<Serial, string>()("Serial") {}
...
export class SerialService extends ServiceMap.Service<SerialService, {
...
declare class Serial extends ServiceMap.Service<Serial, string>()("Serial") {}
...
declare class SerialService extends ServiceMap.Service<SerialService, {
  readonly next: () => string
  readonly validate: (s: string) => boolean
}>()(
  "SerialService"
...
class CorrelationId extends ServiceMap.Service<CorrelationId, string>()("CorrelationId") {}
class RequestId extends ServiceMap.Service<RequestId, string>()("RequestId") {}
