...
description: Correct-by-construction TypeScript standards. Use for TypeScript engineering (before writing or planning new code) or when another skill needs the user's coding standards.
---
