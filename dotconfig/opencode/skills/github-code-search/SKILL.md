...
description: GitHub code search syntax including qualifiers (repo, org, language, path, symbol, content, is), boolean operations (AND, OR, NOT), regular expressions, exact match quoting, and glob patterns. Use when searching code on GitHub.
---
