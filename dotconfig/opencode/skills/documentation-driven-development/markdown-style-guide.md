...
---
url: https://cirosantilli.com/markdown-style-guide/
title: Markdown Style Guide - Ciro Santilli
description: Readable and portable Markdown style guide.
access_date: 2025-08-18T05:43:23.000Z
current_date: 2025-08-18T05:43:23.350Z
---
...
This is also a major source of style divergence in Markdown, since there are so many ways to achieve the same HTML output, e.g.: Spaces after list marker
...
_Don’t_ use horizontal rules except to indicate the End of a header.
...
_Don’t_ use email autolinks `<[email protected]>`. Use raw HTML instead.
