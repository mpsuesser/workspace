---
url: https://docs.divio.com/documentation-system/how-to-guides/
title: How-to guides | Divio Documentation
description: Find details on how Divio formats how-to guides in our documentation. How-to guides take the reader through the
access_date: 2025-08-16T07:35:21.000Z
current_date: 2025-08-16T07:35:21.848Z
---
...
They are recipes, directions to achieve a specific end - for example: _how to create a web form_; _how to plot a three-dimensional data-set_; _how to enable LDAP authentication_.
...
**The title of a how-to document should tell the user exactly what it does.** _How to create a class-based view_ is a good title. _Creating a class-based view_ or worse, _Class-based views_, are not.

## Example from Divio's documentation​

Have a look at our how-to guides.

![Django how-to example](IMAGE)

Each one of these is an answer to a question, or problem: _how do I...?_ Each title can clearly be preceded by the words “How to”. Each one is a recipe, that takes you through the steps required to complete a specific task.
