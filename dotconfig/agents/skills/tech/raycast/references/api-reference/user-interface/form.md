...
![](https://developers.raycast.com/files/bqURwpu5VThrgZ2yaTZt)
...
![](https://developers.raycast.com/files/iqyp1fz6BGtnV8eqqHch)
...
![](https://developers.raycast.com/files/ERQnSnwzUrIVIZs1YNDb)
...
> * Drafts will be dropped once [`Action.SubmitForm`](https://developers.raycast.com/api-reference/user-interface/pages/-MiwANRaRK1jG1WJw3dy#action.submitform) is triggered.
...
![](https://developers.raycast.com/files/GkGzr0yxJIZWAR2Y39A5)
...
![](https://developers.raycast.com/files/sK3ixZGeSb2jyzWZYw3H)
...
![](https://developers.raycast.com/files/6fyyD9RB4VNsUu2CxHpk)
...
![](https://developers.raycast.com/files/PoGtnUzcArHkEvyTLiNA)
...
![](https://developers.raycast.com/files/xZR7TOj5mNh8yswi26XS)
...
![](https://developers.raycast.com/files/0CoK4316hPYAQbUYKBLi)
...
| icon                                    | A optional icon displayed for the item.                                                                                                                                       | [`Image.ImageLike`](https://developers.raycast.com/api-reference/user-interface/pages/-MiwANRdFuMoKkR6at_E#image.imagelike) | -       |
...
![](https://developers.raycast.com/files/aESwCxMajZfzEaG1zmTF)
...
| icon                                    | An icon to show in the tag.                                       | [`Image.ImageLike`](https://developers.raycast.com/api-reference/user-interface/pages/-MiwANRdFuMoKkR6at_E#image.imagelike) | -       |

### Form.Separator

A form item that shows a separator line. Use for grouping and visually separating form items.

![](https://developers.raycast.com/files/SRy3FCB8Zk5H2ThrFSxA)
...
![](https://developers.raycast.com/files/0VDHHNNa26eL9MMt7onO)

![Single Selection](https://developers.raycast.com/files/qRxk4tc8kk39JuJZ0yrz)
...
![](https://developers.raycast.com/files/GHtfm9QohLMRYkmIxRQL)
...
| type\*   | A type of event                                          | [`Form.Event.Type`](#form.event.type) |
