...
```sh
dprint add https://plugins.dprint.dev/json-0.21.3.wasm
```
...
Alternatively, you can disable all `.gitignore` handling with the `--no-gitignore` CLI flag (see [CLI docs](cli.md#ignoring-gitignore)).
