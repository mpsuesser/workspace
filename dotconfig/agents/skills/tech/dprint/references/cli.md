...
See [Install](install.md) and [Setup](setup.md).
...
After [setting up a configuration file](setup.md), run the `fmt` command:
...
![Example of dprint check output.](https://dprint.dev/images/check-example.png "Example of dprint check output.")
