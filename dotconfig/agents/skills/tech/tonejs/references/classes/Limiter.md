...
Limiter will limit the loudness of an incoming signal. Under the hood it's composed of a [Compressor](Compressor.md) with a fast attack and release and max compression ratio.
...
#### Hierarchy ([view full](../hierarchy.md#Limiter))

- [ToneAudioNode](ToneAudioNode.md)<[LimiterOptions](../interfaces/LimiterOptions.md)>
  - Limiter

- Defined in [Tone/component/dynamics/Limiter.ts:28](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/Limiter.ts#L28)

## Constructors

### constructor

- new Limiter(threshold?): [Limiter](Limiter.md)
...
- #### Parameters
  ...
  - Defined in [Tone/component/dynamics/Limiter.ts:44](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/Limiter.ts#L44)

- new Limiter(options?): [Limiter](Limiter.md)

- #### Parameters

  - `Optional` options: Partial<[LimiterOptions](../interfaces/LimiterOptions.md)>

  #### Returns [Limiter](Limiter.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/component/dynamics/Limiter.ts:45](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/Limiter.ts#L45)
...
- Defined in [Tone/component/dynamics/Limiter.ts:31](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/Limiter.ts#L31)
...
- Defined in [Tone/component/dynamics/Limiter.ts:29](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/Limiter.ts#L29)
...
- Defined in [Tone/component/dynamics/Limiter.ts:32](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/Limiter.ts#L32)

### `Readonly` threshold

threshold: [Param](Param.md)<"decibels">

- Defined in [Tone/component/dynamics/Limiter.ts:39](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/Limiter.ts#L39)
...
- A read-only decibel value for metering purposes, representing the current amount of gain reduction that the compressor is applying to the signal.
  ...
  - Defined in [Tone/component/dynamics/Limiter.ts:77](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/Limiter.ts#L77)
...
- Dispose and disconnect
  ...
  - Defined in [Tone/component/dynamics/Limiter.ts:81](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/Limiter.ts#L81)
...
- get(): [LimiterOptions](../interfaces/LimiterOptions.md)

- Get the object's attributes.

  #### Returns [LimiterOptions](../interfaces/LimiterOptions.md)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[LimiterOptions](../interfaces/LimiterOptions.md)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](Limiter.md#toDestination)
...
- getDefaults(): [LimiterOptions](../interfaces/LimiterOptions.md)

- #### Returns [LimiterOptions](../interfaces/LimiterOptions.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[getDefaults](ToneAudioNode.md#getDefaults)

  - Defined in [Tone/component/dynamics/Limiter.ts:67](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/Limiter.ts#L67)
