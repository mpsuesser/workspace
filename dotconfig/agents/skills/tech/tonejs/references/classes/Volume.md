...
#### Hierarchy ([view full](../hierarchy.md#Volume))

- [ToneAudioNode](ToneAudioNode.md)<VolumeOptions>
  - Volume

- Defined in [Tone/component/channel/Volume.ts:24](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Volume.ts#L24)

## Constructors

### constructor

- new Volume(volume?): [Volume](Volume.md)
...
- #### Parameters
  ...
  #### Returns [Volume](Volume.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/component/channel/Volume.ts:54](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Volume.ts#L54)

- new Volume(options?): [Volume](Volume.md)

- #### Parameters

  - `Optional` options: Partial<VolumeOptions>

  #### Returns [Volume](Volume.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/component/channel/Volume.ts:55](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Volume.ts#L55)
...
input: [Gain](Gain.md)<"decibels">

Input and output are the same

Overrides [ToneAudioNode](ToneAudioNode.md).[input](ToneAudioNode.md#input)

- Defined in [Tone/component/channel/Volume.ts:35](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Volume.ts#L35)
...
- Defined in [Tone/component/channel/Volume.ts:25](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Volume.ts#L25)

### output

output: [Gain](Gain.md)<"decibels">

the output node

Overrides [ToneAudioNode](ToneAudioNode.md).[output](ToneAudioNode.md#output)

- Defined in [Tone/component/channel/Volume.ts:30](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Volume.ts#L30)
...
- Defined in [Tone/component/channel/Volume.ts:49](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Volume.ts#L49)
...
- Mute the output.
  ...
  - Defined in [Tone/component/channel/Volume.ts:90](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Volume.ts#L90)
...
- #### Parameters
  ...
  - Defined in [Tone/component/channel/Volume.ts:93](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Volume.ts#L93)
...
- clean up
  ...
  - Defined in [Tone/component/channel/Volume.ts:106](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Volume.ts#L106)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<VolumeOptions>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](Volume.md#toDestination)
...
- getDefaults(): VolumeOptions

- #### Returns VolumeOptions

  Overrides [ToneAudioNode](ToneAudioNode.md).[getDefaults](ToneAudioNode.md#getDefaults)

  - Defined in [Tone/component/channel/Volume.ts:75](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Volume.ts#L75)
