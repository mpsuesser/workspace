...
#### Hierarchy ([view full](../hierarchy.md#MembraneSynth))

- [Synth](Synth.md)<[MembraneSynthOptions](../interfaces/MembraneSynthOptions.md)>
  - MembraneSynth

- Defined in [Tone/instrument/MembraneSynth.ts:27](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/MembraneSynth.ts#L27)

## Constructors

### constructor

- new MembraneSynth(options?): [MembraneSynth](MembraneSynth.md)

- #### Parameters

  - `Optional` options: RecursivePartial<[MembraneSynthOptions](../interfaces/MembraneSynthOptions.md)>
    the options available for the synth see defaults

  #### Returns [MembraneSynth](MembraneSynth.md)

  Overrides [Synth](Synth.md).[constructor](Synth.md#constructor)

  - Defined in [Tone/instrument/MembraneSynth.ts:54](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/MembraneSynth.ts#L54)
...
Inherited from [Synth](Synth.md).[context](Synth.md#context)
...
Inherited from [Synth](Synth.md).[debug](Synth.md#debug)
...
Inherited from [Synth](Synth.md).[detune](Synth.md#detune)

- Defined in [Tone/instrument/Synth.ts:55](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/Synth.ts#L55)
...
Inherited from [Synth](Synth.md).[envelope](Synth.md#envelope)

- Defined in [Tone/instrument/Synth.ts:60](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/Synth.ts#L60)
...
Inherited from [Synth](Synth.md).[frequency](Synth.md#frequency)

- Defined in [Tone/instrument/Synth.ts:50](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/Synth.ts#L50)
...
Inherited from [Synth](Synth.md).[input](Synth.md#input)
...
name: string = "MembraneSynth"

Overrides [Synth](Synth.md).[name](Synth.md#name)

- Defined in [Tone/instrument/MembraneSynth.ts:28](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/MembraneSynth.ts#L28)
...
- Defined in [Tone/instrument/MembraneSynth.ts:36](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/MembraneSynth.ts#L36)
...
Inherited from [Synth](Synth.md).[onsilence](Synth.md#onsilence)
...
Inherited from [Synth](Synth.md).[oscillator](Synth.md#oscillator)

- Defined in [Tone/instrument/Synth.ts:45](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/Synth.ts#L45)

### output

output: [OutputNode](../types/OutputNode.md)

Inherited from [Synth](Synth.md).[output](Synth.md#output)
...
- Defined in [Tone/instrument/MembraneSynth.ts:44](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/MembraneSynth.ts#L44)
...
Overrides [Synth](Synth.md).[portamento](Synth.md#portamento)

- Defined in [Tone/instrument/MembraneSynth.ts:49](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/MembraneSynth.ts#L49)
...
Inherited from [Synth](Synth.md).[volume](Synth.md#volume)
...
Inherited from [Synth](Synth.md).[version](Synth.md#version)
...
- The number of seconds of 1 processing block (128 samples)
  ...
  Inherited from Synth.blockTime
...
- channelCount is the number of channels used when up-mixing and down-mixing connections to any inputs to the node. The default value is 2 except for specific nodes where its value is specially determined.
  ...
  Inherited from Synth.channelCount
...
- channelCountMode determines how channels will be counted when up-mixing and down-mixing connections to any inputs to the node. The default value is "max". This attribute has no effect for nodes with no inputs.
  ...
  Inherited from Synth.channelCountMode
...
- channelInterpretation determines how individual channels will be treated when up-mixing and down-mixing connections to any inputs to the node. The default value is "speakers".
  ...
  Inherited from Synth.channelInterpretation
...
- The number of inputs feeding into the AudioNode. For source nodes, this will be 0.
  ...
  Inherited from Synth.numberOfInputs
...
- The number of outputs of the AudioNode.
  ...
  Inherited from Synth.numberOfOutputs
...
- The duration in seconds of one sample.
  ...
  Inherited from Synth.sampleTime
...
- Connect the output of this node to the rest of the nodes in series.
  ...
  Inherited from [Synth](Synth.md).[chain](Synth.md#chain)
...
- connect the output of a ToneAudioNode to an AudioParam, AudioNode, or ToneAudioNode
  ...
  Inherited from [Synth](Synth.md).[connect](Synth.md#connect)
...
- disconnect the output
  ...
  Inherited from [Synth](Synth.md).[disconnect](Synth.md#disconnect)
...
- clean up
  ...
  Overrides [Synth](Synth.md).[dispose](Synth.md#dispose)

  - Defined in [Tone/instrument/MembraneSynth.ts:98](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/MembraneSynth.ts#L98)
...
- connect the output of this node to the rest of the nodes in parallel.
  ...
  Inherited from [Synth](Synth.md).[fan](Synth.md#fan)
...
- get(): [MembraneSynthOptions](../interfaces/MembraneSynthOptions.md)

- Get the object's attributes.

  #### Returns [MembraneSynthOptions](../interfaces/MembraneSynthOptions.md)
  ...
  Inherited from [Synth](Synth.md).[get](Synth.md#get)
...
- #### Parameters
  ...
  Inherited from [Synth](Synth.md).[getLevelAtTime](Synth.md#getLevelAtTime)

  - Defined in [Tone/instrument/Synth.ts:151](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/Synth.ts#L151)
...
- Return the current time of the Context clock without any lookAhead.
  ...
  Inherited from [Synth](Synth.md).[immediate](Synth.md#immediate)
...
- Return the current time of the Context clock plus the lookAhead.
  ...
  Inherited from [Synth](Synth.md).[now](Synth.md#now)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[MembraneSynthOptions](../interfaces/MembraneSynthOptions.md)>
  ...
  Inherited from [Synth](Synth.md).[set](Synth.md#set)
...
- Set the note at the given time. If no time is given, the note will set immediately.
  ...
  Overrides [Synth](Synth.md).[setNote](Synth.md#setNote)

  - Defined in [Tone/instrument/MembraneSynth.ts:84](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/MembraneSynth.ts#L84)

### sync

- sync(): this

- Sync the instrument to the Transport. All subsequent calls of [triggerAttack](MembraneSynth.md#triggerAttack) and [triggerRelease](MembraneSynth.md#triggerRelease) will be scheduled along the transport.
  ...
  Inherited from [Synth](Synth.md).[sync](Synth.md#sync)
...
- Connect the output to the context's destination node.
  ...
  Inherited from [Synth](Synth.md).[toDestination](Synth.md#toDestination)
...
- Convert the input to a frequency number
  ...
  Inherited from [Synth](Synth.md).[toFrequency](Synth.md#toFrequency)
...
- Connect the output to the context's destination node.
  ...
  [toDestination](MembraneSynth.md#toDestination)

  #### Deprecated

  Inherited from [Synth](Synth.md).[toMaster](Synth.md#toMaster)
...
- Convert the incoming time to seconds. This is calculated against the current TransportClass bpm
  ...
  Inherited from [Synth](Synth.md).[toSeconds](Synth.md#toSeconds)
...
- Convert the class to a string
  ...
  Inherited from [Synth](Synth.md).[toString](Synth.md#toString)
...
- Convert the input time into ticks
  ...
  Inherited from [Synth](Synth.md).[toTicks](Synth.md#toTicks)
...
- Trigger the attack of the note optionally with a given velocity.
  ...
  Inherited from [Synth](Synth.md).[triggerAttack](Synth.md#triggerAttack)
...
- Trigger the attack and then the release after the duration.
  ...
  Inherited from [Synth](Synth.md).[triggerAttackRelease](Synth.md#triggerAttackRelease)
...
- Trigger the release portion of the envelope.
  ...
  Inherited from [Synth](Synth.md).[triggerRelease](Synth.md#triggerRelease)
...
- Unsync the instrument from the Transport
  ...
  Inherited from [Synth](Synth.md).[unsync](Synth.md#unsync)
...
- getDefaults(): [MembraneSynthOptions](../interfaces/MembraneSynthOptions.md)

- #### Returns [MembraneSynthOptions](../interfaces/MembraneSynthOptions.md)

  Overrides [Synth](Synth.md).[getDefaults](Synth.md#getDefaults)

  - Defined in [Tone/instrument/MembraneSynth.ts:67](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/MembraneSynth.ts#L67)
