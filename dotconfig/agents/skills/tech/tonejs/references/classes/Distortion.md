...
- Effect<[DistortionOptions](../interfaces/DistortionOptions.md)>
  - Distortion

- Defined in [Tone/effect/Distortion.ts:20](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Distortion.ts#L20)

## Constructors

### constructor

- new Distortion(distortion?): [Distortion](Distortion.md)
...
- #### Parameters
  ...
  #### Returns [Distortion](Distortion.md)

  Overrides Effect<DistortionOptions>.constructor

  - Defined in [Tone/effect/Distortion.ts:36](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Distortion.ts#L36)

- new Distortion(options?): [Distortion](Distortion.md)

- #### Parameters

  - `Optional` options: Partial<[DistortionOptions](../interfaces/DistortionOptions.md)>

  #### Returns [Distortion](Distortion.md)

  Overrides Effect<DistortionOptions>.constructor

  - Defined in [Tone/effect/Distortion.ts:37](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Distortion.ts#L37)
...
- Defined in [Tone/effect/Distortion.ts:21](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Distortion.ts#L21)
...
- The amount of distortion. Nominal range is between 0 and 1.
  ...
  - Defined in [Tone/effect/Distortion.ts:68](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Distortion.ts#L68)

- set distortion(amount): void
...
- #### Parameters
  ...
  - Defined in [Tone/effect/Distortion.ts:71](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Distortion.ts#L71)
...
- The oversampling of the effect. Can either be "none", "2x" or "4x".
  ...
  - Defined in [Tone/effect/Distortion.ts:88](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Distortion.ts#L88)
...
- #### Parameters
  ...
  - Defined in [Tone/effect/Distortion.ts:91](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Distortion.ts#L91)
...
- #### Returns this
  ...
  - Defined in [Tone/effect/Distortion.ts:95](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Distortion.ts#L95)
...
- get(): [DistortionOptions](../interfaces/DistortionOptions.md)

- Get the object's attributes.

  #### Returns [DistortionOptions](../interfaces/DistortionOptions.md)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[DistortionOptions](../interfaces/DistortionOptions.md)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](Distortion.md#toDestination)
...
- getDefaults(): [DistortionOptions](../interfaces/DistortionOptions.md)

- #### Returns [DistortionOptions](../interfaces/DistortionOptions.md)

  Overrides Effect.getDefaults

  - Defined in [Tone/effect/Distortion.ts:58](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/effect/Distortion.ts#L58)
