...
Synth is composed simply of a [OmniOscillator](OmniOscillator.md) routed through an [AmplitudeEnvelope](AmplitudeEnvelope.md).
...
- Options extends [SynthOptions](../interfaces/SynthOptions.md) = [SynthOptions](../interfaces/SynthOptions.md)

#### Hierarchy ([view full](../hierarchy.md#Synth))

- Monophonic<[Options](Synth.md#constructor.new_Synth.Options-1)>
  - Synth
    - [MembraneSynth](MembraneSynth.md)

- Defined in [Tone/instrument/Synth.ts:37](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/Synth.ts#L37)

## Constructors

### constructor

- new Synth<[Options](Synth.md#constructor.new_Synth.Options-1)>(options?): [Synth](Synth.md)<[Options](Synth.md#constructor.new_Synth.Options-1)>
...
- #### Type Parameters
  ...
  - `Optional` options: RecursivePartial<[SynthOptions](../interfaces/SynthOptions.md)>
    the options available for the synth.

  #### Returns [Synth](Synth.md)<[Options](Synth.md#constructor.new_Synth.Options-1)>

  Overrides Monophonic<Options>.constructor

  - Defined in [Tone/instrument/Synth.ts:65](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/Synth.ts#L65)
...
- Defined in [Tone/instrument/Synth.ts:40](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/Synth.ts#L40)
...
- clean up
  ...
  - Defined in [Tone/instrument/Synth.ts:159](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/Synth.ts#L159)
...
- get(): [Options](Synth.md#constructor.new_Synth.Options-1)

- Get the object's attributes.

  #### Returns [Options](Synth.md#constructor.new_Synth.Options-1)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[Options](Synth.md#constructor.new_Synth.Options-1)>
...
- Sync the instrument to the Transport. All subsequent calls of [triggerAttack](Synth.md#triggerAttack) and [triggerRelease](Synth.md#triggerRelease) will be scheduled along the transport.
...
- Connect the output to the context's destination node.
  ...
  [toDestination](Synth.md#toDestination)
...
- getDefaults(): [SynthOptions](../interfaces/SynthOptions.md)

- #### Returns [SynthOptions](../interfaces/SynthOptions.md)

  Overrides Monophonic.getDefaults

  - Defined in [Tone/instrument/Synth.ts:98](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/instrument/Synth.ts#L98)
