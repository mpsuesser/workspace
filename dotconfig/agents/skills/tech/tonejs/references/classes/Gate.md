...
Gate only passes a signal through when the incoming signal exceeds a specified threshold. It uses [Follower](Follower.md) to follow the ampltiude of the incoming signal and compares it to the [threshold](Gate.md#threshold) value using [GreaterThan](GreaterThan.md).
...
#### Hierarchy ([view full](../hierarchy.md#Gate))

- [ToneAudioNode](ToneAudioNode.md)<[GateOptions](../interfaces/GateOptions.md)>
  - Gate

- Defined in [Tone/component/dynamics/Gate.ts:29](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/Gate.ts#L29)

## Constructors

### constructor

- new Gate(threshold?, smoothing?): [Gate](Gate.md)

- #### Parameters

  - `Optional` threshold: number
    The threshold above which the gate will open.
  - `Optional` smoothing: [Unit](../modules/Unit.md).[Time](../types/Unit.Time.md)
    The follower's smoothing time

  #### Returns [Gate](Gate.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/component/dynamics/Gate.ts:54](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/Gate.ts#L54)

- new Gate(options?): [Gate](Gate.md)

- #### Parameters

  - `Optional` options: Partial<[GateOptions](../interfaces/GateOptions.md)>

  #### Returns [Gate](Gate.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/component/dynamics/Gate.ts:55](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/Gate.ts#L55)
...
- Defined in [Tone/component/dynamics/Gate.ts:32](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/Gate.ts#L32)
...
- Defined in [Tone/component/dynamics/Gate.ts:30](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/Gate.ts#L30)
...
- Defined in [Tone/component/dynamics/Gate.ts:33](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/Gate.ts#L33)
...
- get smoothing(): [Unit](../modules/Unit.md).[Time](../types/Unit.Time.md)
...
- The attack/decay speed of the gate.
  ...
  [Follower.smoothing](Follower.md#smoothing)

  - Defined in [Tone/component/dynamics/Gate.ts:101](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/Gate.ts#L101)

- set smoothing(smoothingTime): void

- #### Parameters

  - smoothingTime: [Unit](../modules/Unit.md).[Time](../types/Unit.Time.md)

  #### Returns void

  - Defined in [Tone/component/dynamics/Gate.ts:104](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/Gate.ts#L104)
...
- The threshold of the gate in decibels
  ...
  - Defined in [Tone/component/dynamics/Gate.ts:90](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/Gate.ts#L90)

- set threshold(thresh): void
...
- #### Parameters
  ...
  - Defined in [Tone/component/dynamics/Gate.ts:93](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/Gate.ts#L93)
...
- Dispose and disconnect
  ...
  - Defined in [Tone/component/dynamics/Gate.ts:108](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/Gate.ts#L108)
...
- get(): [GateOptions](../interfaces/GateOptions.md)

- Get the object's attributes.

  #### Returns [GateOptions](../interfaces/GateOptions.md)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[GateOptions](../interfaces/GateOptions.md)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](Gate.md#toDestination)
...
- getDefaults(): [GateOptions](../interfaces/GateOptions.md)

- #### Returns [GateOptions](../interfaces/GateOptions.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[getDefaults](ToneAudioNode.md#getDefaults)

  - Defined in [Tone/component/dynamics/Gate.ts:80](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/dynamics/Gate.ts#L80)
