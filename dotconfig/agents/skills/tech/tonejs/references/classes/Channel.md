...
[PanVol](PanVol.md) and [Solo](Solo.md)
...
#### Hierarchy ([view full](../hierarchy.md#Channel))

- [ToneAudioNode](ToneAudioNode.md)<[ChannelOptions](../interfaces/ChannelOptions.md)>
  - Channel

- Defined in [Tone/component/channel/Channel.ts:31](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Channel.ts#L31)

## Constructors

### constructor

- new Channel(volume?, pan?): [Channel](Channel.md)
...
- #### Parameters
  ...
  - Defined in [Tone/component/channel/Channel.ts:63](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Channel.ts#L63)

- new Channel(options?): [Channel](Channel.md)

- #### Parameters

  - `Optional` options: Partial<[ChannelOptions](../interfaces/ChannelOptions.md)>

  #### Returns [Channel](Channel.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/component/channel/Channel.ts:64](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Channel.ts#L64)
...
- Defined in [Tone/component/channel/Channel.ts:34](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Channel.ts#L34)
...
- Defined in [Tone/component/channel/Channel.ts:32](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Channel.ts#L32)
...
- Defined in [Tone/component/channel/Channel.ts:35](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Channel.ts#L35)

### `Readonly` pan

pan: [Param](Param.md)<"audioRange">
...
- Defined in [Tone/component/channel/Channel.ts:52](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Channel.ts#L52)
...
- Defined in [Tone/component/channel/Channel.ts:57](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Channel.ts#L57)
...
- Mute/unmute the volume
  ...
  - Defined in [Tone/component/channel/Channel.ts:121](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Channel.ts#L121)
...
- #### Parameters
  ...
  - Defined in [Tone/component/channel/Channel.ts:124](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Channel.ts#L124)
...
- If the current instance is muted, i.e. another instance is soloed, or the channel is muted
  ...
  - Defined in [Tone/component/channel/Channel.ts:114](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Channel.ts#L114)
...
- Solo/unsolo the channel. Soloing is only relative to other [Channel](Channel.md)s and [Solo](Solo.md) instances

  #### Returns boolean

  - Defined in [Tone/component/channel/Channel.ts:103](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Channel.ts#L103)
...
- #### Parameters
  ...
  - Defined in [Tone/component/channel/Channel.ts:106](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Channel.ts#L106)
...
- Dispose and disconnect
  ...
  - Defined in [Tone/component/channel/Channel.ts:177](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Channel.ts#L177)
...
- get(): [ChannelOptions](../interfaces/ChannelOptions.md)

- Get the object's attributes.

  #### Returns [ChannelOptions](../interfaces/ChannelOptions.md)
...
- Receive audio from a channel which was connected with [send](Channel.md#send).
  ...
  - Defined in [Tone/component/channel/Channel.ts:171](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Channel.ts#L171)

### send

- send(name, volume?): [Gain](Gain.md)<"decibels">

- Send audio to another channel using a string. `send` is a lot like [connect](Channel.md#connect), except it uses a string instead of an object. This can be useful in large applications to decouple sections since [send](Channel.md#send) and [receive](Channel.md#receive) can be invoked separately in order to connect an object
  ...
  #### Returns [Gain](Gain.md)<"decibels">

  Returns the gain node of this connection.

  - Defined in [Tone/component/channel/Channel.ts:155](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Channel.ts#L155)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[ChannelOptions](../interfaces/ChannelOptions.md)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](Channel.md#toDestination)
...
- getDefaults(): [ChannelOptions](../interfaces/ChannelOptions.md)

- #### Returns [ChannelOptions](../interfaces/ChannelOptions.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[getDefaults](ToneAudioNode.md#getDefaults)

  - Defined in [Tone/component/channel/Channel.ts:90](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/channel/Channel.ts#L90)
