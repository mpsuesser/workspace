...
- MeterBase<[FFTOptions](../interfaces/FFTOptions.md)>
  - FFT

- Defined in [Tone/component/analysis/FFT.ts:19](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/FFT.ts#L19)

## Constructors

### constructor

- new FFT(size?): [FFT](FFT.md)
...
- #### Parameters
  ...
  Overrides MeterBase<FFTOptions>.constructor

  - Defined in [Tone/component/analysis/FFT.ts:32](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/FFT.ts#L32)

- new FFT(options?): [FFT](FFT.md)

- #### Parameters

  - `Optional` options: Partial<[FFTOptions](../interfaces/FFTOptions.md)>

  #### Returns [FFT](FFT.md)

  Overrides MeterBase<FFTOptions>.constructor

  - Defined in [Tone/component/analysis/FFT.ts:33](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/FFT.ts#L33)
...
Inherited from MeterBase.context
...
Inherited from MeterBase.debug
...
Inherited from MeterBase.input

- Defined in [Tone/component/analysis/MeterBase.ts:23](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/MeterBase.ts#L23)

### `Readonly` name

name: string = "FFT"

Overrides MeterBase.name

- Defined in [Tone/component/analysis/FFT.ts:20](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/FFT.ts#L20)
...
- Defined in [Tone/component/analysis/FFT.ts:27](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/FFT.ts#L27)
...
Inherited from MeterBase.output

- Defined in [Tone/component/analysis/MeterBase.ts:28](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/MeterBase.ts#L28)
...
Inherited from MeterBase.version
...
- The number of seconds of 1 processing block (128 samples)
  ...
  Inherited from MeterBase.blockTime
...
- channelCount is the number of channels used when up-mixing and down-mixing connections to any inputs to the node. The default value is 2 except for specific nodes where its value is specially determined.
  ...
  Inherited from MeterBase.channelCount
...
- channelCountMode determines how channels will be counted when up-mixing and down-mixing connections to any inputs to the node. The default value is "max". This attribute has no effect for nodes with no inputs.
  ...
  Inherited from MeterBase.channelCountMode
...
- channelInterpretation determines how individual channels will be treated when up-mixing and down-mixing connections to any inputs to the node. The default value is "speakers".
  ...
  Inherited from MeterBase.channelInterpretation
...
- Indicates if the instance was disposed. 'Disposing' an instance means that all of the Web Audio nodes that were created for the instance are disconnected and freed for garbage collection.
  ...
  Inherited from MeterBase.disposed
...
- The number of inputs feeding into the AudioNode. For source nodes, this will be 0.
  ...
  Inherited from MeterBase.numberOfInputs
...
- The number of outputs of the AudioNode.
  ...
  Inherited from MeterBase.numberOfOutputs
...
- The duration in seconds of one sample.
  ...
  Inherited from MeterBase.sampleTime
...
- The size of analysis. This must be a power of two in the range 16 to 16384. Determines the size of the array returned by [getValue](FFT.md#getValue) (i.e. the number of frequency bins). Large FFT sizes may be costly to compute.

  #### Returns number

  - Defined in [Tone/component/analysis/FFT.ts:67](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/FFT.ts#L67)
...
- #### Parameters
  ...
  - Defined in [Tone/component/analysis/FFT.ts:70](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/FFT.ts#L70)
...
- 0 represents no time averaging with the last analysis frame.
  ...
  - Defined in [Tone/component/analysis/FFT.ts:77](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/FFT.ts#L77)

- set smoothing(val): void
...
- #### Parameters
  ...
  - Defined in [Tone/component/analysis/FFT.ts:80](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/FFT.ts#L80)
...
- Connect the output of this node to the rest of the nodes in series.
  ...
  Inherited from MeterBase.chain
...
- connect the output of a ToneAudioNode to an AudioParam, AudioNode, or ToneAudioNode
  ...
  Inherited from MeterBase.connect
...
- disconnect the output
  ...
  Inherited from MeterBase.disconnect
...
- #### Returns this
  ...
  Inherited from MeterBase.dispose

  - Defined in [Tone/component/analysis/MeterBase.ts:49](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/MeterBase.ts#L49)
...
- get(): [FFTOptions](../interfaces/FFTOptions.md)

- Get the object's attributes.

  #### Returns [FFTOptions](../interfaces/FFTOptions.md)
...
- Returns the frequency value in hertz of each of the indices of the FFT's [getValue](FFT.md#getValue) response.
  ...
  - Defined in [Tone/component/analysis/FFT.ts:90](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/FFT.ts#L90)

### getValue

- getValue(): Float32Array

- Gets the current frequency data from the connected audio source. Returns the frequency data of length [size](FFT.md#size) as a Float32Array of decibel values.

  #### Returns Float32Array

  - Defined in [Tone/component/analysis/FFT.ts:57](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/FFT.ts#L57)
...
- Return the current time of the Context clock without any lookAhead.
  ...
  Inherited from MeterBase.immediate
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[FFTOptions](../interfaces/FFTOptions.md)>
...
- Connect the output to the context's destination node.
  ...
  Inherited from MeterBase.toDestination
...
- Convert the input to a frequency number
  ...
  Inherited from MeterBase.toFrequency
...
- Connect the output to the context's destination node.
  ...
  [toDestination](FFT.md#toDestination)

  #### Deprecated

  Inherited from MeterBase.toMaster
...
- Convert the incoming time to seconds. This is calculated against the current TransportClass bpm
  ...
  Inherited from MeterBase.toSeconds
...
- Convert the class to a string
  ...
  Inherited from MeterBase.toString
...
- Convert the input time into ticks
  ...
  Inherited from MeterBase.toTicks
...
- getDefaults(): [FFTOptions](../interfaces/FFTOptions.md)

- #### Returns [FFTOptions](../interfaces/FFTOptions.md)

  Overrides MeterBase.getDefaults

  - Defined in [Tone/component/analysis/FFT.ts:45](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/FFT.ts#L45)
