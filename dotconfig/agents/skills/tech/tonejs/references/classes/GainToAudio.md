...
[AudioToGain](AudioToGain.md).

#### Hierarchy

- SignalOperator<[ToneAudioNodeOptions](../types/ToneAudioNodeOptions.md)>
  - GainToAudio

- Defined in [Tone/signal/GainToAudio.ts:10](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/GainToAudio.ts#L10)

## Constructors

### constructor

- new GainToAudio(options?): [GainToAudio](GainToAudio.md)

- #### Parameters

  - `Optional` options: Partial<ToneWithContextOptions>

  #### Returns [GainToAudio](GainToAudio.md)

  Inherited from SignalOperator<ToneAudioNodeOptions>.constructor

  - Defined in [Tone/signal/SignalOperator.ts:17](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/SignalOperator.ts#L17)
...
input: [WaveShaper](WaveShaper.md) = ...

The NormalRange input \[0, 1\]

Overrides SignalOperator.input

- Defined in [Tone/signal/GainToAudio.ts:24](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/GainToAudio.ts#L24)

### `Readonly` name

name: string = "GainToAudio"

Overrides SignalOperator.name

- Defined in [Tone/signal/GainToAudio.ts:11](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/GainToAudio.ts#L11)

### output

output: [WaveShaper](WaveShaper.md) = ...

The AudioRange output \[-1, 1\]

Overrides SignalOperator.output

- Defined in [Tone/signal/GainToAudio.ts:29](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/GainToAudio.ts#L29)
...
- clean up
  ...
  - Defined in [Tone/signal/GainToAudio.ts:34](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/signal/GainToAudio.ts#L34)
...
- Connect the output to the context's destination node.
  ...
  [toDestination](GainToAudio.md#toDestination)
...
- #### Returns ToneWithContextOptions
  ...
  Inherited from SignalOperator.getDefaults
