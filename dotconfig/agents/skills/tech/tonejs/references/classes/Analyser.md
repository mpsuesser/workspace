...
Wrapper around the native Web Audio's [AnalyserNode](http://webaudio.github.io/web-audio-api/#idl-def-AnalyserNode). Extracts FFT or Waveform data from the incoming signal.

#### Hierarchy ([view full](../hierarchy.md#Analyser))

- [ToneAudioNode](ToneAudioNode.md)<[AnalyserOptions](../interfaces/AnalyserOptions.md)>
  - Analyser

- Defined in [Tone/component/analysis/Analyser.ts:27](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Analyser.ts#L27)

## Constructors

### constructor

- new Analyser(type?, size?): [Analyser](Analyser.md)

- #### Parameters

  - `Optional` type: [AnalyserType](../types/AnalyserType.md)
  ...
  #### Returns [Analyser](Analyser.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/component/analysis/Analyser.ts:62](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Analyser.ts#L62)

- new Analyser(options?): [Analyser](Analyser.md)

- #### Parameters

  - `Optional` options: Partial<[AnalyserOptions](../interfaces/AnalyserOptions.md)>

  #### Returns [Analyser](Analyser.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[constructor](ToneAudioNode.md#constructor)

  - Defined in [Tone/component/analysis/Analyser.ts:63](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Analyser.ts#L63)
...
- Defined in [Tone/component/analysis/Analyser.ts:30](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Analyser.ts#L30)

### `Readonly` name

name: string = "Analyser"

The name of the class

Overrides [ToneAudioNode](ToneAudioNode.md).[name](ToneAudioNode.md#name)

- Defined in [Tone/component/analysis/Analyser.ts:28](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Analyser.ts#L28)
...
- Defined in [Tone/component/analysis/Analyser.ts:31](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Analyser.ts#L31)
...
- The number of channels the analyser does the analysis on. Channel separation is done using [Split](Split.md)

  #### Returns number

  - Defined in [Tone/component/analysis/Analyser.ts:144](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Analyser.ts#L144)
...
- The size of analysis. This must be a power of two in the range 16 to 16384.
  ...
  - Defined in [Tone/component/analysis/Analyser.ts:130](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Analyser.ts#L130)
...
- #### Parameters
  ...
  - Defined in [Tone/component/analysis/Analyser.ts:133](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Analyser.ts#L133)
...
- 0 represents no time averaging with the last analysis frame.
  ...
  - Defined in [Tone/component/analysis/Analyser.ts:165](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Analyser.ts#L165)
...
- #### Parameters
  ...
  - Defined in [Tone/component/analysis/Analyser.ts:168](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Analyser.ts#L168)

### type

- get type(): [AnalyserType](../types/AnalyserType.md)

- The analysis function returned by analyser.getValue(), either "fft" or "waveform".

  #### Returns [AnalyserType](../types/AnalyserType.md)

  - Defined in [Tone/component/analysis/Analyser.ts:151](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Analyser.ts#L151)

- set type(type): void

- #### Parameters

  - type: [AnalyserType](../types/AnalyserType.md)

  #### Returns void

  - Defined in [Tone/component/analysis/Analyser.ts:154](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Analyser.ts#L154)
...
- Clean up.
  ...
  - Defined in [Tone/component/analysis/Analyser.ts:175](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Analyser.ts#L175)
...
- get(): [AnalyserOptions](../interfaces/AnalyserOptions.md)

- Get the object's attributes.

  #### Returns [AnalyserOptions](../interfaces/AnalyserOptions.md)
...
- Run the analysis given the current settings. If [channels](Analyser.md#channels) = 1, it will return a Float32Array. If [channels](Analyser.md#channels) > 1, it will return an array of Float32Arrays where each index in the array represents the analysis done on a channel.

  #### Returns Float32Array \| Float32Array\[\]

  - Defined in [Tone/component/analysis/Analyser.ts:111](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Analyser.ts#L111)
...
- Set multiple properties at once with an object.
  ...
  - props: RecursivePartial<[AnalyserOptions](../interfaces/AnalyserOptions.md)>
...
- Connect the output to the context's destination node.
  ...
  [toDestination](Analyser.md#toDestination)
...
- getDefaults(): [AnalyserOptions](../interfaces/AnalyserOptions.md)

- #### Returns [AnalyserOptions](../interfaces/AnalyserOptions.md)

  Overrides [ToneAudioNode](ToneAudioNode.md).[getDefaults](ToneAudioNode.md#getDefaults)

  - Defined in [Tone/component/analysis/Analyser.ts:96](https://github.com/Tonejs/Tone.js/blob/d2d52ffa8803b35debd9f19f2da08ad1c3540de0/Tone/component/analysis/Analyser.ts#L96)
